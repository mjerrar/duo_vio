...
extern void d_fprintf(double formatSpec, double varargin_1);
...
extern void n_fprintf(double formatSpec, double varargin_1);
extern void p_fprintf(double formatSpec, double varargin_1);
