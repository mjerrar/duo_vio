  ...
  validFeatures_size[1])
{
  ...
  i23 = c_anchorFeatures->size[0] * c_anchorFeatures->size[1];
  c_anchorFeatures->size[0] = 24;
  c_anchorFeatures->size[1] = b_anchorFeatures->size[1];
  emxEnsureCapacity((emxArray__common *)c_anchorFeatures, i23, (int)sizeof
                    (boolean_T));
  loop_ub = b_anchorFeatures->size[0] * b_anchorFeatures->size[1];
  for (i23 = 0; i23 < loop_ub; i23++) {
    c_anchorFeatures->data[i23] = (b_anchorFeatures->data[i23] == 1.0);
  }
  ...
  for (i23 = 0; i23 < loop_ub; i23++) {
    indMeas_data[i23] = (signed char)ii_data[i23];
  }
  ...
  K->size[0] = 1;
  K->size[1] = 1;
  emxEnsureCapacity((emxArray__common *)K, i23, (int)sizeof(double));
  K->data[0] = 0.0;

  //  for coder
  i23 = H->size[0] * H->size[1];
  H->size[0] = 1;
  H->size[1] = 1;
  emxEnsureCapacity((emxArray__common *)H, i23, (int)sizeof(double));
  H->data[0] = 0.0;

  //  for coder
  for (i23 = 0; i23 < idx; i23++) {
    x_data[i23 << 1] = (signed char)((indMeas_data[i23] - 1) * 2 + 1);
  }

  for (i23 = 0; i23 < idx; i23++) {
    x_data[1 + (i23 << 1)] = (signed char)((indMeas_data[i23] - 1) * 2 + 2);
  }
  ...
  for (i23 = 0; i23 < nx; i23++) {
    tmp_data[i23] = z_all_l[(int)indMeas_z_data[i23] - 1];
  }
  ...
  for (i23 = 0; i23 < nx; i23++) {
    z_all_l[(int)indMeas_z_data[i23] - 1] = tmp_data[i23];
  }
  ...
  for (i23 = 0; i23 < idx; i23++) {
    HI_inlierStatus_data[i23] = true;
  }

  b_emxInit_real_T(&x_apo_prev, 1);

  //  high innovation inliers
  i23 = x_apo_prev->size[0];
  x_apo_prev->size[0] = b_P->size[0];
  emxEnsureCapacity((emxArray__common *)x_apo_prev, i23, (int)sizeof(double));
  ib = b_P->size[0];
  for (i23 = 0; i23 < ib; i23++) {
    x_apo_prev->data[i23] = 0.0;
  }
  ...
  while ((!exitg1) && (it <= (int)b_VIOParameters.max_ekf_iterations - 1)) {
    ...
    indMeas_size[0] = nx;
    for (i23 = 0; i23 < nx; i23++) {
      b_indMeas_data[i23] = indMeas_data[ii_data[i23] - 1];
    }
    ...
    if (1.0 + (double)it == 1.0) {
      ...
      if ((H->size[1] == 1) || (b_P->size[0] == 1)) {
        ...
        for (i23 = 0; i23 < ib; i23++) {
          ...
          for (i24 = 0; i24 < idx; i24++) {
            y->data[i23 + y->size[0] * i24] = 0.0;
            ii = H->size[1];
            for (ar = 0; ar < ii; ar++) {
              y->data[i23 + y->size[0] * i24] += H->data[i23 + H->size[0] * ar] *
                b_P->data[ar + b_P->size[0] * i24];
            }
          }
        }
      } else {
      ...
      for (i23 = 0; i23 < ib; i23++) {
        idx = H->size[1];
        for (i24 = 0; i24 < idx; i24++) {
          b->data[i24 + b->size[0] * i23] = H->data[i23 + H->size[0] * i24];
        }
      }
      ...
      if ((y->size[1] == 1) || (b->size[0] == 1)) {
        ...
        for (i23 = 0; i23 < ib; i23++) {
          ...
          for (i24 = 0; i24 < idx; i24++) {
            ...
            ii = y->size[1];
            for (ar = 0; ar < ii; ar++) {
              b_y->data[i23 + b_y->size[0] * i24] += y->data[i23 + y->size[0] *
      ...
      for (i23 = 0; i23 < ib; i23++) {
        S_data[i23] = b_y->data[i23] + R_data[i23];
      }
      ...
      for (k = 0; k < loop_ub; k++) {
        ...
        for (i23 = 0; i23 < 2; i23++) {
          r[i23] = r_data[i23 + ar];
          for (i24 = 0; i24 < 2; i24++) {
            S[i24 + (i23 << 1)] = S_data[(i24 + ii) + nx * (i23 + idx)];
          }
        }
        ...
        d_numStatesxt = 0.0;
        for (i23 = 0; i23 < 2; i23++) {
          d_numStatesxt += a[i23] * r_data[i23 + ar];
        }
        ...
        if (d_numStatesxt > 6.0) {
          ...
          for (i23 = 0; i23 < ib; i23++) {
            for (i24 = 0; i24 < 2; i24++) {
              H->data[(i24 + ar) + H->size[0] * i23] = 0.0;
            }
          }
    ...
    if ((y->size[1] == 1) || (b->size[0] == 1)) {
      ...
      for (i23 = 0; i23 < ib; i23++) {
        ...
        for (i24 = 0; i24 < idx; i24++) {
          ...
          ii = y->size[1];
          for (ar = 0; ar < ii; ar++) {
            C->data[i23 + C->size[0] * i24] += y->data[i23 + y->size[0] * ar] *
    ...
    if ((b_P->size[1] == 1) || (b->size[0] == 1)) {
      ...
      for (i23 = 0; i23 < ib; i23++) {
        ...
        for (i24 = 0; i24 < idx; i24++) {
          ...
          ii = b_P->size[1];
          for (ar = 0; ar < ii; ar++) {
            y->data[i23 + y->size[0] * i24] += b_P->data[i23 + b_P->size[0] * ar]
              * b->data[ar + b->size[0] * i24];
          }
        }
      }
    ...
    for (i23 = 0; i23 < ib; i23++) {
      C_data[i23] = C->data[i23] + R_data[i23];
    }
    ...
    if ((K->size[1] == 1) || (r_size[0] == 1)) {
      ...
      emxEnsureCapacity((emxArray__common *)x_apo, i23, (int)sizeof(double));
      ib = K->size[0];
      for (i23 = 0; i23 < ib; i23++) {
        x_apo->data[i23] = 0.0;
        idx = K->size[1];
        for (i24 = 0; i24 < idx; i24++) {
          x_apo->data[i23] += K->data[i23 + K->size[0] * i24] * r_data[i24];
        }
      }
    } else {
      k = K->size[1];
    ...
    for (i23 = 0; i23 < 3; i23++) {
      d_xt[i23] = b_xt->data[i23] + x_apo->data[i23];
    }

    for (i23 = 0; i23 < 3; i23++) {
      b_xt->data[i23] = d_xt[i23];
    }

    for (i23 = 0; i23 < 3; i23++) {
      d_xt[i23] = x_apo->data[3 + i23];
    }

    quatPlusThetaJ(d_xt, dv11);
    quatmultJ(dv11, *(double (*)[4])&b_xt->data[3], S);
    for (i23 = 0; i23 < 4; i23++) {
      b_xt->data[3 + i23] = S[i23];
    }
    ...
    ib = i24 - i23;
    for (i24 = 0; i24 < ib; i24++) {
      c_xt->data[i24] = b_xt->data[i23 + i24] + x_apo->data[ar + i24];
    }

    ib = r10->size[1];
    for (i23 = 0; i23 < ib; i23++) {
      b_xt->data[r10->data[r10->size[0] * i23]] = c_xt->data[(*(int (*)[2])
        r10->size)[0] * i23];
    }

    for (idx = 0; idx < b_anchorFeatures->size[1]; idx++) {
      for (i23 = 0; i23 < 24; i23++) {
        x[i23] = (b_anchorFeatures->data[i23 + b_anchorFeatures->size[0] * idx] ==
                  1.0);
      }
      ...
      if (any(x)) {
        ...
        d_numStates = c_numStates + ((1.0 + (double)idx) - 1.0) * (6.0 +
          numPointsPerAnchor);
        for (i23 = 0; i23 < 3; i23++) {
          d_xt[i23] = b_xt->data[(int)(e_numStatesxt + (1.0 + (double)i23)) - 1]
            + x_apo->data[(int)(d_numStates + (1.0 + (double)i23)) - 1];
        }

        for (i23 = 0; i23 < 3; i23++) {
          b_xt->data[(int)(d_numStatesxt + (1.0 + (double)i23)) - 1] = d_xt[i23];
        }

        d_numStates = c_numStates + ((1.0 + (double)idx) - 1.0) * (6.0 +
          numPointsPerAnchor);
        for (i23 = 0; i23 < 3; i23++) {
          d_xt[i23] = x_apo->data[(int)(d_numStates + (4.0 + (double)i23)) - 1];
        }

        d_numStatesxt = c_numStatesxt + ((1.0 + (double)idx) - 1.0) * (7.0 +
          numPointsPerAnchor);
        for (i23 = 0; i23 < 4; i23++) {
          e_xt[i23] = b_xt->data[(int)(d_numStatesxt + (4.0 + (double)i23)) - 1];
        }
        ...
        d_numStatesxt = c_numStatesxt + ((1.0 + (double)idx) - 1.0) * (7.0 +
          numPointsPerAnchor);
        for (i23 = 0; i23 < 4; i23++) {
          b_xt->data[(int)(d_numStatesxt + (4.0 + (double)i23)) - 1] = S[i23];
        }
    ...
    emxEnsureCapacity((emxArray__common *)b_x_apo, i23, (int)sizeof(double));
    ib = x_apo->size[0];
    for (i23 = 0; i23 < ib; i23++) {
      b_x_apo->data[i23] = x_apo->data[i23] - x_apo_prev->data[i23];
    }
    ...
    if (d_norm(b_x_apo) < 0.001) {
      ...
      ib = x_apo->size[0];
      for (i23 = 0; i23 < ib; i23++) {
        x_apo_prev->data[i23] = x_apo->data[i23];
      }
  ...
  if ((K->size[1] == 1) || (H->size[0] == 1)) {
    ...
    for (i23 = 0; i23 < ib; i23++) {
      ...
      for (i24 = 0; i24 < idx; i24++) {
        ...
        ii = K->size[1];
        for (ar = 0; ar < ii; ar++) {
          C->data[i23 + C->size[0] * i24] += K->data[i23 + K->size[0] * ar] *
            H->data[ar + H->size[0] * i24];
        }
      }
    }
  } else {
  ...
  if ((b_y->size[1] == 1) || (b_P->size[0] == 1)) {
    ...
    for (i23 = 0; i23 < ib; i23++) {
      idx = b_P->size[1];
      for (i24 = 0; i24 < idx; i24++) {
        c_y->data[i23 + c_y->size[0] * i24] = 0.0;
        ii = b_y->size[1];
        for (ar = 0; ar < ii; ar++) {
          c_y->data[i23 + c_y->size[0] * i24] += b_y->data[i23 + b_y->size[0] *
            ar] * b_P->data[ar + b_P->size[0] * i24];
        }
      }
    }

    i23 = b_P->size[0] * b_P->size[1];
    b_P->size[0] = c_y->size[0];
    b_P->size[1] = c_y->size[1];
    emxEnsureCapacity((emxArray__common *)b_P, i23, (int)sizeof(double));
    ib = c_y->size[1];
    for (i23 = 0; i23 < ib; i23++) {
      idx = c_y->size[0];
      for (i24 = 0; i24 < idx; i24++) {
        b_P->data[i24 + b_P->size[0] * i23] = c_y->data[i24 + c_y->size[0] * i23];
      }
    }
  } else {
    k = b_y->size[1];
    ...
    for (i23 = 0; i23 < ib; i23++) {
      idx = (int)a[0];
      for (i24 = 0; i24 < idx; i24++) {
        b_P->data[i24 + b_P->size[0] * i23] = 0.0;
      }
    }
