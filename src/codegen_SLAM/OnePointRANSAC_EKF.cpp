  ...
  validFeatures_data[], int validFeatures_size[1])
{
  ...
  i21 = c_anchorFeatures->size[0] * c_anchorFeatures->size[1];
  c_anchorFeatures->size[0] = 16;
  c_anchorFeatures->size[1] = b_anchorFeatures->size[1];
  emxEnsureCapacity((emxArray__common *)c_anchorFeatures, i21, (int)sizeof
                    (boolean_T));
  loop_ub = b_anchorFeatures->size[0] * b_anchorFeatures->size[1];
  for (i21 = 0; i21 < loop_ub; i21++) {
    c_anchorFeatures->data[i21] = (b_anchorFeatures->data[i21] == 1.0);
  }
  ...
  for (i21 = 0; i21 < loop_ub; i21++) {
    indMeas_data[i21] = (signed char)ii_data[i21];
  }
  ...
  for (i21 = 0; i21 < ar; i21++) {
    LI_inlierStatus_data[i21] = false;
  }
  ...
  while (i < n_hyp) {
      ...
      for (i21 = 0; i21 < ib; i21++) {
        ...
        for (i22 = 0; i22 < idx; i22++) {
          ...
          for (i23 = 0; i23 < ii; i23++) {
            y->data[i21 + y->size[0] * i22] += H_i->data[i21 + H_i->size[0] *
              i23] * b_P->data[i23 + b_P->size[0] * i22];
          }
        }
      }
    } else {
    ...
    for (i21 = 0; i21 < ib; i21++) {
      idx = H_i->size[1];
      for (i22 = 0; i22 < idx; i22++) {
        b->data[i22 + b->size[0] * i21] = H_i->data[i21 + H_i->size[0] * i22];
      }
    }
    ...
    if ((y->size[1] == 1) || (b->size[0] == 1)) {
      ...
      for (i21 = 0; i21 < ib; i21++) {
        ...
        for (i22 = 0; i22 < idx; i22++) {
          ...
          ii = y->size[1];
          for (i23 = 0; i23 < ii; i23++) {
            C->data[i21 + C->size[0] * i22] += y->data[i21 + y->size[0] * i23] *
    ...
    if ((b_P->size[1] == 1) || (b->size[0] == 1)) {
      ...
      for (i21 = 0; i21 < ib; i21++) {
        ...
        for (i22 = 0; i22 < idx; i22++) {
          ...
          ii = b_P->size[1];
          for (i23 = 0; i23 < ii; i23++) {
            y->data[i21 + y->size[0] * i22] += b_P->data[i21 + b_P->size[0] *
              i23] * b->data[i23 + b->size[0] * i22];
          }
        }
      }
    } else {
    ...
    for (i21 = 0; i21 < ib; i21++) {
      C_data[i21] = C->data[i21] + R_data[i21];
    }

    mrdivide(y, C_data, C_size, r14);
    i21 = K_i->size[0] * K_i->size[1];
    K_i->size[0] = r14->size[0];
    K_i->size[1] = r14->size[1];
    emxEnsureCapacity((emxArray__common *)K_i, i21, (int)sizeof(double));
    ib = r14->size[0] * r14->size[1];
    for (i21 = 0; i21 < ib; i21++) {
      K_i->data[i21] = r14->data[i21];
    }
    ...
    if ((K_i->size[1] == 1) || (unusedU2_size[0] == 1)) {
      ...
      for (i21 = 0; i21 < ib; i21++) {
        ...
        idx = K_i->size[1];
        for (i22 = 0; i22 < idx; i22++) {
          x_apo->data[i21] += K_i->data[i21 + K_i->size[0] * i22] * r_data[i22];
        }
      }
    } else {
      k = K_i->size[1];
    ...
    ib = b_xt->size[0];
    for (i21 = 0; i21 < ib; i21++) {
      x_apo_prev->data[i21] = b_xt->data[i21];
    }

    for (i21 = 0; i21 < 3; i21++) {
      x_apo_prev->data[i21] = b_xt->data[i21] + x_apo->data[i21];
    }
    ...
    quatPlusThetaJ(c_xt, dv333);
    quatmultJ(dv333, *(double (*)[4])&x_apo_prev->data[3], dv334);
    for (i21 = 0; i21 < 4; i21++) {
      x_apo_prev->data[3 + i21] = dv334[i21];
    }
    ...
    idx = r15->size[0];
    r15->size[0] = (i22 - i21) + 1;
    emxEnsureCapacity((emxArray__common *)r15, idx, (int)sizeof(int));
    ib = i22 - i21;
    for (i22 = 0; i22 <= ib; i22++) {
      r15->data[i22] = i21 + i22;
    }

    i21 = r16->size[0];
    r16->size[0] = (ar - i23) + 1;
    emxEnsureCapacity((emxArray__common *)r16, i21, (int)sizeof(int));
    ib = ar - i23;
    for (i21 = 0; i21 <= ib; i21++) {
      r16->data[i21] = i23 + i21;
    }

    i21 = b_x_apo_prev->size[0];
    b_x_apo_prev->size[0] = r13->size[0] * r13->size[1];
    emxEnsureCapacity((emxArray__common *)b_x_apo_prev, i21, (int)sizeof(double));
    ib = r13->size[0] * r13->size[1];
    for (i21 = 0; i21 < ib; i21++) {
      b_x_apo_prev->data[i21] = x_apo_prev->data[r15->data[i21] - 1] +
        x_apo->data[r16->data[i21] - 1];
    }

    ib = b_x_apo_prev->size[0];
    for (i21 = 0; i21 < ib; i21++) {
      x_apo_prev->data[r13->data[i21]] = b_x_apo_prev->data[i21];
    }
    ...
    for (br = 0; br < numAnchors; br++) {
      ...
      if (any(x)) {
        ...
        d_numStates = c_numStates + ((1.0 + (double)br) - 1.0) * (6.0 +
          numPointsPerAnchor);
        for (i21 = 0; i21 < 3; i21++) {
          c_xt[i21] = x_apo_prev->data[(int)(d_numStatesxt + (1.0 + (double)i21))
            - 1] + x_apo->data[(int)(d_numStates + (1.0 + (double)i21)) - 1];
        }

        for (i21 = 0; i21 < 3; i21++) {
          x_apo_prev->data[(int)(e_numStatesxt + (1.0 + (double)i21)) - 1] =
            c_xt[i21];
        }
        ...
        e_numStatesxt = c_numStatesxt + ((1.0 + (double)br) - 1.0) * (7.0 +
          numPointsPerAnchor);
        for (i21 = 0; i21 < 4; i21++) {
          d_xt[i21] = x_apo_prev->data[(int)(e_numStatesxt + (4.0 + (double)i21))
            - 1];
        }

        quatPlusThetaJ(c_xt, dv335);
        quatmultJ(dv335, d_xt, dv334);
        e_numStatesxt = c_numStatesxt + ((1.0 + (double)br) - 1.0) * (7.0 +
          numPointsPerAnchor);
        for (i21 = 0; i21 < 4; i21++) {
          x_apo_prev->data[(int)(e_numStatesxt + (4.0 + (double)i21)) - 1] =
            dv334[i21];
        }
    ...
    R_cw[8] = ((-(x_apo_prev->data[3] * x_apo_prev->data[3]) - x_apo_prev->data
                [4] * x_apo_prev->data[4]) + x_apo_prev->data[5] *
               x_apo_prev->data[5]) + x_apo_prev->data[6] * x_apo_prev->data[6];
    for (i21 = 0; i21 < numMeas; i21++) {
      HI_inlierStatus_data[i21] = false;
    }
    ...
    for (br = 0; br < numAnchors; br++) {
      ...
      for (i21 = 0; i21 < ib; i21++) {
        featureIdxVect_data[i21] = (signed char)ii_data[i21];
      }
      ...
      for (idx = 0; idx < ar; idx++) {
        if (b_anchorFeatures->data[(featureIdxVect_data[idx] +
          ...
          e_numStatesxt = c_numStatesxt + ((1.0 + (double)br) - 1.0) * (7.0 +
            numPointsPerAnchor);
          for (i21 = 0; i21 < 3; i21++) {
            anchorPos[i21] = x_apo_prev->data[(int)(e_numStatesxt + (1.0 +
              (double)i21)) - 1];
          }
          ...
          for (i21 = 0; i21 < 3; i21++) {
            d_numStatesxt = 0.0;
            for (i22 = 0; i22 < 3; i22++) {
              d_numStatesxt += c_x_apo_prev[i21 + 3 * i22] * b_m_vect->data[i22
                + b_m_vect->size[0] * (featureIdxVect_data[idx] - 1)];
            }

            b_anchorPos[i21] = (anchorPos[i21] + d_numStatesxt / d_numStates) -
              x_apo_prev->data[iv13[i21]];
          }

          for (i21 = 0; i21 < 3; i21++) {
            c_xt[i21] = 0.0;
            for (i22 = 0; i22 < 3; i22++) {
              c_xt[i21] += R_cw[i21 + 3 * i22] * b_anchorPos[i22];
            }
          }
          ...
          for (i21 = 0; i21 < 2; i21++) {
            b_z_all_l[i21] = z_all_l[(ii + iv14[i21]) - 1] - r[i21];
          }
    ...
    if (idx > ii) {
      for (i21 = 0; i21 < numMeas; i21++) {
        LI_inlierStatus_data[i21] = HI_inlierStatus_data[i21];
      }
  ...
  if (idx > 3) {
    ...
    for (iter = 0; iter < 3; iter++) {
      ...
      if ((H->size[1] == 1) || (b_P->size[0] == 1)) {
        ...
        for (i21 = 0; i21 < ib; i21++) {
          ...
          for (i22 = 0; i22 < idx; i22++) {
            ...
            ii = H->size[1];
            for (i23 = 0; i23 < ii; i23++) {
              y->data[i21 + y->size[0] * i22] += H->data[i21 + H->size[0] * i23]
                * b_P->data[i23 + b_P->size[0] * i22];
            }
          }
        }
      } else {
      ...
      quatPlusThetaJ(c_xt, dv336);
      quatmultJ(dv336, *(double (*)[4])&b_xt->data[3], dv334);
      for (i21 = 0; i21 < 4; i21++) {
        b_xt->data[3 + i21] = dv334[i21];
      }
      ...
      ib = i22 - i21;
      for (i22 = 0; i22 < ib; i22++) {
        e_xt->data[i22] = b_xt->data[i21 + i22] + x_apo->data[i23 + i22];
      }

      ib = r13->size[1];
      for (i21 = 0; i21 < ib; i21++) {
        b_xt->data[r13->data[r13->size[0] * i21]] = e_xt->data[(*(int (*)[2])
          r13->size)[0] * i21];
      }
      ...
      for (br = 0; br < numAnchors; br++) {
        ...
        if (any(x)) {
          ...
          d_numStates = c_numStates + ((1.0 + (double)br) - 1.0) * (6.0 +
            numPointsPerAnchor);
          for (i21 = 0; i21 < 3; i21++) {
            c_xt[i21] = b_xt->data[(int)(d_numStatesxt + (1.0 + (double)i21)) -
              1] + x_apo->data[(int)(d_numStates + (1.0 + (double)i21)) - 1];
          }

          for (i21 = 0; i21 < 3; i21++) {
            b_xt->data[(int)(e_numStatesxt + (1.0 + (double)i21)) - 1] =
              c_xt[i21];
          }
          ...
          e_numStatesxt = c_numStatesxt + ((1.0 + (double)br) - 1.0) * (7.0 +
            numPointsPerAnchor);
          for (i21 = 0; i21 < 4; i21++) {
            d_xt[i21] = b_xt->data[(int)(e_numStatesxt + (4.0 + (double)i21)) -
              1];
          }

          quatPlusThetaJ(c_xt, dv337);
          quatmultJ(dv337, d_xt, dv334);
          e_numStatesxt = c_numStatesxt + ((1.0 + (double)br) - 1.0) * (7.0 +
            numPointsPerAnchor);
          for (i21 = 0; i21 < 4; i21++) {
            b_xt->data[(int)(e_numStatesxt + (4.0 + (double)i21)) - 1] =
              dv334[i21];
          }
    ...
    if ((K->size[1] == 1) || (H->size[0] == 1)) {
      ...
      for (i21 = 0; i21 < ib; i21++) {
        ...
        for (i22 = 0; i22 < idx; i22++) {
          ...
          ii = K->size[1];
          for (i23 = 0; i23 < ii; i23++) {
            C->data[i21 + C->size[0] * i22] += K->data[i21 + K->size[0] * i23] *
              H->data[i23 + H->size[0] * i22];
          }
        }
      }
    } else {
    ...
    for (i21 = 0; i21 < ib; i21++) {
      b->data[i21] = b_P->data[i21];
    }

    emxInit_real_T(&c_a, 2);
    if ((b_a->size[1] == 1) || (b_P->size[0] == 1)) {
      i21 = c_a->size[0] * c_a->size[1];
      c_a->size[0] = b_a->size[0];
      c_a->size[1] = b_P->size[1];
      emxEnsureCapacity((emxArray__common *)c_a, i21, (int)sizeof(double));
      ib = b_a->size[0];
      for (i21 = 0; i21 < ib; i21++) {
        idx = b_P->size[1];
        for (i22 = 0; i22 < idx; i22++) {
          c_a->data[i21 + c_a->size[0] * i22] = 0.0;
          ii = b_a->size[1];
          for (i23 = 0; i23 < ii; i23++) {
            c_a->data[i21 + c_a->size[0] * i22] += b_a->data[i21 + b_a->size[0] *
              i23] * b_P->data[i23 + b_P->size[0] * i22];
          }
        }
      }

      i21 = b_P->size[0] * b_P->size[1];
      b_P->size[0] = c_a->size[0];
      b_P->size[1] = c_a->size[1];
      emxEnsureCapacity((emxArray__common *)b_P, i21, (int)sizeof(double));
      ib = c_a->size[1];
      for (i21 = 0; i21 < ib; i21++) {
        idx = c_a->size[0];
        for (i22 = 0; i22 < idx; i22++) {
          b_P->data[i22 + b_P->size[0] * i21] = c_a->data[i22 + c_a->size[0] *
            i21];
        }
      }
    } else {
      ...
      for (i21 = 0; i21 < ib; i21++) {
        idx = (int)a[0];
        for (i22 = 0; i22 < idx; i22++) {
          b_P->data[i22 + b_P->size[0] * i21] = 0.0;
        }
      }
  ...
  ib = b_P->size[0];
  for (i21 = 0; i21 < ib; i21++) {
    x_apo_prev->data[i21] = 0.0;
  }

  i21 = K->size[0] * K->size[1];
  K->size[0] = 1;
  K->size[1] = 1;
  emxEnsureCapacity((emxArray__common *)K, i21, (int)sizeof(double));
  K->data[0] = 0.0;
  ...
  H->size[0] = 1;
  H->size[1] = 1;
  emxEnsureCapacity((emxArray__common *)H, i21, (int)sizeof(double));
  H->data[0] = 0.0;

  //  for coder
  i21 = (int)maxEKFIterations;
  it = 0;
  b_emxInit_real_T(&b_x_apo, 1);
  b_emxInit_real_T(&f_xt, 1);
  exitg1 = false;
  while ((!exitg1) && (it <= i21 - 1)) {
    ii = loop_ub - 1;
    br = 0;
    for (idx = 0; idx <= ii; idx++) {
    ...
    if (1.0 + (double)it == 1.0) {
      ...
      if ((y->size[1] == 1) || (b->size[0] == 1)) {
        ...
        for (i22 = 0; i22 < ib; i22++) {
          idx = b->size[1];
          for (i23 = 0; i23 < idx; i23++) {
            b_a->data[i22 + b_a->size[0] * i23] = 0.0;
            ii = y->size[1];
            for (ar = 0; ar < ii; ar++) {
              b_a->data[i22 + b_a->size[0] * i23] += y->data[i22 + y->size[0] *
      ...
      for (i22 = 0; i22 < ib; i22++) {
        S_data[i22] = b_a->data[i22] + b_R_data[i22];
      }
      ...
      for (k = 0; k < numMeas; k++) {
        ...
        idx = k << 1;
        for (i22 = 0; i22 < 2; i22++) {
          r[i22] = b_r_data[i22 + ar];
          for (i23 = 0; i23 < 2; i23++) {
            d_xt[i23 + (i22 << 1)] = S_data[(i23 + ii) + br * (i22 + idx)];
          }
        }
    ...
    ib = C->size[0] * C->size[1];
    for (i22 = 0; i22 < ib; i22++) {
      b_C_data[i22] = C->data[i22] + b_R_data[i22];
    }
    ...
    if ((K->size[1] == 1) || (r_size[0] == 1)) {
      ...
      for (i22 = 0; i22 < ib; i22++) {
        ...
        idx = K->size[1];
        for (i23 = 0; i23 < idx; i23++) {
          x_apo->data[i22] += K->data[i22 + K->size[0] * i23] * b_r_data[i23];
        }
      }
    } else {
      k = K->size[1];
    ...
    for (i22 = 0; i22 < 3; i22++) {
      c_xt[i22] = b_xt->data[i22] + x_apo->data[i22];
    }

    for (i22 = 0; i22 < 3; i22++) {
      b_xt->data[i22] = c_xt[i22];
    }

    for (i22 = 0; i22 < 3; i22++) {
      c_xt[i22] = x_apo->data[3 + i22];
    }

    quatPlusThetaJ(c_xt, dv338);
    quatmultJ(dv338, *(double (*)[4])&b_xt->data[3], dv334);
    for (i22 = 0; i22 < 4; i22++) {
      b_xt->data[3 + i22] = dv334[i22];
    }
    ...
    for (i23 = 0; i23 < ib; i23++) {
      f_xt->data[i23] = b_xt->data[i22 + i23] + x_apo->data[ar + i23];
    }

    ib = r13->size[1];
    for (i22 = 0; i22 < ib; i22++) {
      b_xt->data[r13->data[r13->size[0] * i22]] = f_xt->data[(*(int (*)[2])
        r13->size)[0] * i22];
    }

    for (br = 0; br < numAnchors; br++) {
      for (i22 = 0; i22 < 16; i22++) {
        x[i22] = (b_anchorFeatures->data[i22 + b_anchorFeatures->size[0] * br] ==
                  1.0);
      }
      ...
      if (any(x)) {
        ...
        d_numStates = c_numStates + ((1.0 + (double)br) - 1.0) * (6.0 +
          numPointsPerAnchor);
        for (i22 = 0; i22 < 3; i22++) {
          c_xt[i22] = b_xt->data[(int)(d_numStatesxt + (1.0 + (double)i22)) - 1]
            + x_apo->data[(int)(d_numStates + (1.0 + (double)i22)) - 1];
        }

        for (i22 = 0; i22 < 3; i22++) {
          b_xt->data[(int)(e_numStatesxt + (1.0 + (double)i22)) - 1] = c_xt[i22];
        }

        d_numStates = c_numStates + ((1.0 + (double)br) - 1.0) * (6.0 +
          numPointsPerAnchor);
        for (i22 = 0; i22 < 3; i22++) {
          c_xt[i22] = x_apo->data[(int)(d_numStates + (4.0 + (double)i22)) - 1];
        }

        e_numStatesxt = c_numStatesxt + ((1.0 + (double)br) - 1.0) * (7.0 +
          numPointsPerAnchor);
        for (i22 = 0; i22 < 4; i22++) {
          d_xt[i22] = b_xt->data[(int)(e_numStatesxt + (4.0 + (double)i22)) - 1];
        }

        quatPlusThetaJ(c_xt, dv339);
        quatmultJ(dv339, d_xt, dv334);
        e_numStatesxt = c_numStatesxt + ((1.0 + (double)br) - 1.0) * (7.0 +
          numPointsPerAnchor);
        for (i22 = 0; i22 < 4; i22++) {
          b_xt->data[(int)(e_numStatesxt + (4.0 + (double)i22)) - 1] = dv334[i22];
        }
  ...
  if ((b_a->size[1] == 1) || (b_P->size[0] == 1)) {
    i21 = d_a->size[0] * d_a->size[1];
    d_a->size[0] = b_a->size[0];
    d_a->size[1] = b_P->size[1];
    emxEnsureCapacity((emxArray__common *)d_a, i21, (int)sizeof(double));
    loop_ub = b_a->size[0];
    for (i21 = 0; i21 < loop_ub; i21++) {
      ib = b_P->size[1];
      for (i22 = 0; i22 < ib; i22++) {
        d_a->data[i21 + d_a->size[0] * i22] = 0.0;
        idx = b_a->size[1];
        for (i23 = 0; i23 < idx; i23++) {
          d_a->data[i21 + d_a->size[0] * i22] += b_a->data[i21 + b_a->size[0] *
            i23] * b_P->data[i23 + b_P->size[0] * i22];
        }
      }
    }
    ...
    for (i21 = 0; i21 < loop_ub; i21++) {
      ib = d_a->size[0];
      for (i22 = 0; i22 < ib; i22++) {
        b_P->data[i22 + b_P->size[0] * i21] = d_a->data[i22 + d_a->size[0] * i21];
      }
    }
  } else {
    k = b_a->size[1];
