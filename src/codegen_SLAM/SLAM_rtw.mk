...
## Generated on : Fri Aug 07 11:38:38 2015
## MATLAB Coder version: 2.8 (R2015a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\SLAM.lib
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:\Users\naegelit\GoogleDrive\AITGit\SLAM\StereoSLAM_invDepth_NoRciTciAccOff
ARCH                      = win64
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\SLAM.lib
...
INCLUDES_BUILDINFO = $(START_DIR);$(START_DIR)\codegen\lib\SLAM;$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert
...
DEFINES_STANDARD = -DMODEL=SLAM -DHAVESTDIO -DUSE_RTMODEL
...
OBJS = SLAM.obj rt_nonfinite.obj rtGetNaN.obj rtGetInf.obj
...
{$(START_DIR)\codegen\lib\SLAM}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\codegen\lib\SLAM}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
