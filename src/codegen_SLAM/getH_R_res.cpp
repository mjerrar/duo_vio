                  ...
                  int h_u_size[1], double R_data[], int R_size[2])
{
  ...
  while (k <= indMeas_size[0] - 1) {
    ...
    dv17[0] = 1.0 / h_rz[2];
    dv17[2] = 0.0;
    dv17[4] = -h_rz[0] / (h_rz[2] * h_rz[2]);
    dv17[1] = 0.0;
    dv17[3] = 1.0 / h_rz[2];
    dv17[5] = -h_rz[1] / (h_rz[2] * h_rz[2]);
    for (i1 = 0; i1 < 2; i1++) {
      for (ic = 0; ic < 2; ic++) {
    ...
    for (i1 = 0; i1 < kidx; i1++) {
      for (ic = 0; ic < 2; ic++) {
        H_xc->data[iv3[ic] + H_xc->size[0] * r2->data[i1]] = d_h_un_To_h_d_l[ic
          + (i1 << 1)];
      }
    }
    ...
    for (i1 = 0; i1 < 3; i1++) {
      for (ic = 0; ic < 3; ic++) {
        H_iy->data[ic + H_iy->size[0] * (i1 + 3)] = -dv18[ic + 3 * i1];
      }
    }
    ...
    for (i1 = 0; i1 < ia; i1++) {
      for (ic = 0; ic < 2; ic++) {
        H_xm->data[iv3[ic] + H_xm->size[0] * r2->data[i1]] = C->data[ic +
          C->size[0] * i1];
      }
    }
  ...
  if (gravityUpdate) {
    ...
    for (i1 = 0; i1 < 3; i1++) {
      for (ic = 0; ic < 3; ic++) {
        H_g->data[ic + H_g->size[0] * (3 + i1)] = dv20[ic + 3 * i1];
      }
    }
                ...
                double R_data[], int R_size[2])
{
  ...
  for (ar = 0; ar < 3; ar++) {
    for (br = 0; br < 3; br++) {
      H_iy->data[br + H_iy->size[0] * (ar + 3)] = -dv13[br + 3 * ar];
    }
  }
  ...
  if (gravityUpdate) {
    ...
    for (ar = 0; ar < 3; ar++) {
      for (br = 0; br < 3; br++) {
        H_g->data[br + H_g->size[0] * (3 + ar)] = dv15[br + 3 * ar];
      }
    }
