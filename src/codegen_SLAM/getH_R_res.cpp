                  ...
                  int h_u_size[1], double R_data[], int R_size[2])
{
  ...
  while (k <= indMeas_size[0] - 1) {
    ...
    for (i1 = 0; i1 < 3; i1++) {
      d3 = 0.0;
      for (ic = 0; ic < 3; ic++) {
        d3 += anchorRot[ic + 3 * i1] * b_m_vect->data[ic + b_m_vect->size[0] *
    ...
    for (i1 = 0; i1 < 3; i1++) {
      d3 = 0.0;
      for (ic = 0; ic < 3; ic++) {
        d3 += b_anchorRot[i1 + 3 * ic] * b_m_vect->data[ic + b_m_vect->size[0] *
          ((int)indMeas_data[k] - 1)];
      }
                ...
                double R_data[], int R_size[2])
{
  ...
  for (ar = 0; ar < 3; ar++) {
    d2 = 0.0;
    for (br = 0; br < 3; br++) {
      d2 += anchorRot[br + 3 * ar] * b_m_vect->data[br + b_m_vect->size[0] *
        ((int)indMeas - 1)];
    }
  ...
  for (ar = 0; ar < 3; ar++) {
    d2 = 0.0;
    for (br = 0; br < 3; br++) {
      d2 += b_anchorRot[ar + 3 * br] * b_m_vect->data[br + b_m_vect->size[0] *
        ((int)indMeas - 1)];
    }
