                ...
                R_data[], int R_size[2])
{
  ...
  while (k <= indMeas_size[0] - 1) {
    ...
    for (ib = 0; ib < 3; ib++) {
      y[ib] = 0.0;
      for (ar = 0; ar < 3; ar++) {
        b_y = y[ib] + e_xt[ib + 3 * ar] * b_m_vect->data[ar + b_m_vect->size[0] *
    ...
    for (ib = 0; ib < 3; ib++) {
      for (ar = 0; ar < 3; ar++) {
        g_xt[ib + 3 * ar] = 0.0;
        for (br = 0; br < 3; br++) {
          g_xt[ib + 3 * ar] += f_xt * R_cw[ib + 3 * br] * dv1[br + 3 * ar];
        }
      }
    }
    ...
    for (ib = 0; ib < 3; ib++) {
      for (ar = 0; ar < 3; ar++) {
        H_orientation->data[ar + H_orientation->size[0] * (ib + 3)] = g_xt[ar +
          3 * ib];
      }
    }
  ...
  if (b_VIOParameters.use_orientation) {
    ...
    for (ib = 0; ib < 3; ib++) {
      for (ar = 0; ar < 3; ar++) {
        e_xt[ib + 3 * ar] = 0.0;
        for (br = 0; br < 3; br++) {
          e_xt[ib + 3 * ar] += R_bc[br + 3 * ib] * b_measurements[br + 3 * ar];
        }
      }
      ...
      for (ar = 0; ar < 3; ar++) {
        dv1[ib + 3 * ar] = 0.0;
        for (br = 0; br < 3; br++) {
          dv1[ib + 3 * ar] += e_xt[ib + 3 * br] * R_cw[ar + 3 * br];
        }
      }
    }
