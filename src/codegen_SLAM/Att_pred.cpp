              ...
              const double w[3], double q, double dt, double x[4], double b_P[9])
{
  ...
  for (k = 0; k < 3; k++) {
    I[k + 3 * k] = 1.0;
    for (i14 = 0; i14 < 3; i14++) {
      Phi[i14 + 3 * k] = I[i14 + 3 * k] + -a[i14 + 3 * k] * dt;
    }
  }
  ...
  if (P_size[0] == 1) {
    ...
    for (i14 = 0; i14 < 3; i14++) {
      ...
      for (cr = 0; cr < k; cr++) {
        y_data[i14 + 3 * cr] = 0.0;
        for (br = 0; br < 3; br++) {
          y_data[i14 + 3 * cr] += Phi[i14 + 3 * br] * P_data[br + cr];
        }
      }
    }
  } else {
  ...
  if (y_size_idx_1 == 1) {
    for (i14 = 0; i14 < 3; i14++) {
      for (cr = 0; cr < 3; cr++) {
        Phi[i14 + 3 * cr] = 0.0;
        for (br = 0; br < 3; br++) {
          Phi[i14 + 3 * cr] += y_data[i14 + 3 * br] * I[br + 3 * cr];
        }
      }
    }
  } else {
  ...
  for (i14 = 0; i14 < 3; i14++) {
    for (cr = 0; cr < 3; cr++) {
      a[i14 + 3 * cr] = 0.0;
      for (br = 0; br < 3; br++) {
        a[i14 + 3 * cr] += (double)c_a[i14 + 3 * br] * ((double)b_a[br + 3 * cr]
          * q * c);
      }
    }
  }
  ...
  for (i14 = 0; i14 < 3; i14++) {
    for (cr = 0; cr < 3; cr++) {
      c = 0.0;
      for (br = 0; br < 3; br++) {
        c += a[i14 + 3 * br] * (double)c_a[br + 3 * cr];
      }

      b_P[i14 + 3 * cr] = Phi[i14 + 3 * cr] + c;
    }
  }
