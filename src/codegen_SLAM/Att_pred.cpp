...
void Att_pred(double x[4], double b_P[9], const double w[3], double q, double dt)
{
  ...
  for (k = 0; k < 3; k++) {
    I[k + 3 * k] = 1;
    for (i17 = 0; i17 < 3; i17++) {
      b_Phi[i17 + 3 * k] = (double)I[i17 + 3 * k] + -Phi[i17 + 3 * k] * dt;
    }
  }
  ...
  for (i17 = 0; i17 < 3; i17++) {
    for (k = 0; k < 3; k++) {
      Phi[i17 + 3 * k] = 0.0;
      for (i18 = 0; i18 < 3; i18++) {
        Phi[i17 + 3 * k] += b_Phi[i17 + 3 * i18] * b_P[i18 + 3 * k];
      }

      a[i17 + 3 * k] = 0.0;
      for (i18 = 0; i18 < 3; i18++) {
        a[i17 + 3 * k] += (double)d_a[i17 + 3 * i18] * ((double)c_a[i18 + 3 * k]
          * q * c);
      }
    }
    ...
    for (k = 0; k < 3; k++) {
      c_Phi[i17 + 3 * k] = 0.0;
      for (i18 = 0; i18 < 3; i18++) {
        c_Phi[i17 + 3 * k] += Phi[i17 + 3 * i18] * b_Phi[k + 3 * i18];
      }

      b_a[i17 + 3 * k] = 0.0;
      for (i18 = 0; i18 < 3; i18++) {
        b_a[i17 + 3 * k] += a[i17 + 3 * i18] * (double)d_a[i18 + 3 * k];
      }
    }
  }
  ...
  for (i17 = 0; i17 < 3; i17++) {
    for (k = 0; k < 3; k++) {
      b_P[k + 3 * i17] = c_Phi[k + 3 * i17] + b_a[k + 3 * i17];
    }
