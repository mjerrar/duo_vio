                ...
                emxArray_real_T *h_u_apo, emxArray_real_T *map)
{
  ...
  while (i <= (int)c_numTrackFeatures - 1) {
    ...
    for (i16 = 0; i16 < loop_ub; i16++) {
      x->data[x->size[0] * i16] = (anchorFeatures->data[i + anchorFeatures->
        size[0] * i16] == 1.0);
    }
    ...
    if ((!(anchorIdx->size[1] == 0)) && (updateVect[i] != 1.0)) {
      ...
      for (k = 0; k < i16; k++) {
        ...
        emxEnsureCapacity((emxArray__common *)r8, i17, (int)sizeof(int));
        loop_ub = anchorIdx->size[1];
        for (i17 = 0; i17 < loop_ub; i17++) {
          r8->data[i17] = (int)anchorIdx->data[anchorIdx->size[0] * i17];
        }
      ...
      loop_ub = anchorIdx->size[1];
      for (i16 = 0; i16 < loop_ub; i16++) {
        r8->data[i16] = (int)(((numStates + (anchorIdx->data[anchorIdx->size[0] *
          i16] - 1.0) * (6.0 + numPointsPerAnchor)) + 6.0) + (double)n);
      }
      ...
      for (i16 = 0; i16 < loop_ub; i16++) {
        for (i17 = 0; i17 < unnamed_idx_0; i17++) {
          P_apr->data[(r8->data[i17] + P_apr->size[0] * i16) - 1] = 0.0;
        }
      }
      ...
      for (i16 = 0; i16 < nm1d2; i16++) {
        for (i17 = 0; i17 < loop_ub; i17++) {
          P_apr->data[i17 + P_apr->size[0] * (r8->data[i16] - 1)] = 0.0;
        }
      }
      ...
      nm1d2 = r8->size[0];
      for (i16 = 0; i16 < nm1d2; i16++) {
        anchorFeatures->data[i + anchorFeatures->size[0] * (r8->data[i16] - 1)] =
          -1.0;
      }
  ...
  emxEnsureCapacity((emxArray__common *)r9, i16, (int)sizeof(boolean_T));
  loop_ub = anchorFeatures->size[0] * anchorFeatures->size[1];
  for (i16 = 0; i16 < loop_ub; i16++) {
    r9->data[i16] = (anchorFeatures->data[i16] == 1.0);
  }
  ...
  if (!(i18 == 0)) {
    ...
    while (i <= (int)c_numTrackFeatures - 1) {
      ...
      emxEnsureCapacity((emxArray__common *)x, i16, (int)sizeof(boolean_T));
      for (i16 = 0; i16 < loop_ub; i16++) {
        x->data[x->size[0] * i16] = (anchorFeatures->data[i +
  ...
  if (any(b_x)) {
    ...
    while ((!exitg4) && (nm1d2 <= (int)numAnchors - 1)) {
      for (i16 = 0; i16 < 16; i16++) {
        b_x[i16] = ((anchorFeatures->data[i16 + anchorFeatures->size[0] * nm1d2]
    ...
    if (initializeNewAnchor > 0.0) {
      ...
      for (i16 = 0; i16 < 16; i16++) {
        b_x[i16] = (anchorFeatures->data[i16 + anchorFeatures->size[0] * ((int)
      ...
      for (i16 = 0; i16 < 7; i16++) {
        b_xt->data[(int)(anew + (1.0 + (double)i16)) - 1] = c_xt[i16];
      }

      i16 = sigmaInits->size[0];
      sigmaInits->size[0] = (int)numPointsPerAnchor;
      emxEnsureCapacity((emxArray__common *)sigmaInits, i16, (int)sizeof(double));
      loop_ub = (int)numPointsPerAnchor;
      for (i16 = 0; i16 < loop_ub; i16++) {
        sigmaInits->data[i16] = 0.0;
      }
      ...
      while ((unusedFeatureIdx <= ii_size_idx_0 - 1) && (!(featureAnchorIdx >
        ...
        for (i16 = 0; i16 < 2; i16++) {
          z_curr_l[i16] = z_all_l[nm1d2 + i16];
          z_curr_r[i16] = z_all_r[k + i16];
        }
      ...
      loop_ub = anchorIdx->size[1];
      for (i16 = 0; i16 < loop_ub; i16++) {
        r8->data[i16] = (int)(anew + anchorIdx->data[anchorIdx->size[0] * i16]);
      }
      ...
      for (i16 = 0; i16 < loop_ub; i16++) {
        for (i17 = 0; i17 < unnamed_idx_0; i17++) {
          J->data[(r8->data[i17] + J->size[0] * i16) - 1] = 0.0;
        }
      }
      ...
      for (i16 = 0; i16 < 3; i16++) {
        for (i17 = 0; i17 < 3; i17++) {
          J->data[r8->data[i17] + J->size[0] * i16] = iv12[i17 + 3 * i16];
        }
      }

      for (i16 = 0; i16 < 3; i16++) {
        for (i17 = 0; i17 < 3; i17++) {
          J->data[r8->data[i17] + J->size[0] * (i16 + 3)] = 0.0;
        }
      }
      ...
      for (i16 = 0; i16 < loop_ub; i16++) {
        for (i17 = 0; i17 < 3; i17++) {
          J->data[r8->data[i17] + J->size[0] * (i16 + 6)] = 0.0;
        }
      }

      for (i16 = 0; i16 < 3; i16++) {
        for (i17 = 0; i17 < 3; i17++) {
          J->data[r8->data[i17 + 3] + J->size[0] * i16] = 0.0;
        }
      }

      for (i16 = 0; i16 < 3; i16++) {
        for (i17 = 0; i17 < 3; i17++) {
          J->data[r8->data[i17 + 3] + J->size[0] * (i16 + 3)] = iv12[i17 + 3 *
            i16];
        }
      }
      ...
      for (i16 = 0; i16 < loop_ub; i16++) {
        for (i17 = 0; i17 < 3; i17++) {
          J->data[r8->data[i17 + 3] + J->size[0] * (i16 + 6)] = 0.0;
        }
      }
      ...
      for (i16 = 0; i16 < loop_ub; i16++) {
        ...
        for (i17 = 0; i17 < nm1d2; i17++) {
          J->data[r8->data[i17 + 6] + J->size[0] * i16] = 0.0;
        }
      }
        ...
        for (i16 = 0; i16 < loop_ub; i16++) {
          ...
          for (i17 = 0; i17 < nm1d2; i17++) {
            ...
            for (i20 = 0; i20 < b_loop_ub; i20++) {
              y->data[i16 + y->size[0] * i17] += J->data[i16 + J->size[0] * i20]
                * P_apr->data[i20 + P_apr->size[0] * i17];
            }
          }
        }
      } else {
  ...
  if (minNumValidFeatures < minFeatureThreshold) {
    ...
    while ((!exitg1) && (i < 16)) {
      ...
      r11->size[0] = 1;
      r11->size[1] = loop_ub;
      emxEnsureCapacity((emxArray__common *)r11, i16, (int)sizeof(boolean_T));
      for (i16 = 0; i16 < loop_ub; i16++) {
        r11->data[r11->size[0] * i16] = (anchorFeatures->data[i +
          anchorFeatures->size[0] * i16] == 1.0);
      }
  ...
  for (i = 0; i < 16; i++) {
    ...
    for (i16 = 0; i16 < loop_ub; i16++) {
      r12->data[r12->size[0] * i16] = (anchorFeatures->data[i +
        anchorFeatures->size[0] * i16] == 1.0);
    }
    ...
    if (d_any(r12)) {
      ...
      nm1d2 = i << 2;
      for (i16 = 0; i16 < 2; i16++) {
        h_u_apo->data[i16 + nm1d2] = h_u_l[i16];
      }

      for (i16 = 0; i16 < 2; i16++) {
        h_u_apo->data[(i16 + nm1d2) + 2] = h_u_r[i16];
      }
    }
  }
