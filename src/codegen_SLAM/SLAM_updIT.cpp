                ...
                emxArray_real_T *map)
{
  ...
  emxEnsureCapacity((emxArray__common *)r4, i20, (int)sizeof(boolean_T));
  loop_ub = anchorFeatures->size[0] * anchorFeatures->size[1];
  for (i20 = 0; i20 < loop_ub; i20++) {
    r4->data[i20] = (anchorFeatures->data[i20] == 1.0);
  }
  ...
  while (i <= (int)numTrackFeatures - 1) {
    ...
    b_x->size[0] = 1;
    b_x->size[1] = loop_ub;
    emxEnsureCapacity((emxArray__common *)b_x, i20, (int)sizeof(boolean_T));
    for (i20 = 0; i20 < loop_ub; i20++) {
      b_x->data[b_x->size[0] * i20] = (anchorFeatures->data[i +
        anchorFeatures->size[0] * i20] == 1.0);
    }
    ...
    i20 = anchorIdx->size[0] * anchorIdx->size[1];
    anchorIdx->size[0] = 1;
    anchorIdx->size[1] = ii->size[1];
    emxEnsureCapacity((emxArray__common *)anchorIdx, i20, (int)sizeof(double));
    loop_ub = ii->size[0] * ii->size[1];
    for (i20 = 0; i20 < loop_ub; i20++) {
      anchorIdx->data[i20] = ii->data[i20];
    }

    if ((!(anchorIdx->size[1] == 0)) && (updateVect[i] != 1.0)) {
      n = 0;
      i20 = b_anchorIdx->size[0];
      b_anchorIdx->size[0] = anchorIdx->size[1];
      emxEnsureCapacity((emxArray__common *)b_anchorIdx, i20, (int)sizeof(double));
      loop_ub = anchorIdx->size[1];
      for (i20 = 0; i20 < loop_ub; i20++) {
        b_anchorIdx->data[i20] = anchorIdx->data[anchorIdx->size[0] * i20];
      }

      i20 = (i + 1) * b_anchorIdx->size[0];
      for (nx = 0; nx < i20; nx++) {
        i21 = r5->size[0];
        r5->size[0] = anchorIdx->size[1];
        emxEnsureCapacity((emxArray__common *)r5, i21, (int)sizeof(int));
        loop_ub = anchorIdx->size[1];
        for (i21 = 0; i21 < loop_ub; i21++) {
          r5->data[i21] = (int)anchorIdx->data[anchorIdx->size[0] * i21];
        }
      ...
      i20 = r5->size[0];
      r5->size[0] = anchorIdx->size[1];
      emxEnsureCapacity((emxArray__common *)r5, i20, (int)sizeof(int));
      loop_ub = anchorIdx->size[1];
      for (i20 = 0; i20 < loop_ub; i20++) {
        r5->data[i20] = (int)(((numStates + (anchorIdx->data[anchorIdx->size[0] *
          i20] - 1.0) * numStatesPerAnchor) + 6.0) + (double)n);
      }
      ...
      for (i20 = 0; i20 < loop_ub; i20++) {
        for (i21 = 0; i21 < unnamed_idx_0; i21++) {
          P_apr->data[(r5->data[i21] + P_apr->size[0] * i20) - 1] = 0.0;
        }
      }
      ...
      for (i20 = 0; i20 < ixstart; i20++) {
        for (i21 = 0; i21 < loop_ub; i21++) {
          P_apr->data[i21 + P_apr->size[0] * (r5->data[i20] - 1)] = 0.0;
        }
      }
      ...
      loop_ub = anchorIdx->size[1];
      for (i20 = 0; i20 < loop_ub; i20++) {
        r5->data[i20] = (int)anchorIdx->data[anchorIdx->size[0] * i20];
      }

      ixstart = r5->size[0];
      for (i20 = 0; i20 < ixstart; i20++) {
        anchorFeatures->data[i + anchorFeatures->size[0] * (r5->data[i20] - 1)] =
          -1.0;
      }
  ...
  if (b_VIOParameters.fixed_anchor && b_VIOParameters.fixed_feature &&
    ...
    for (i20 = 0; i20 < 24; i20++) {
      x[i20] = (anchorFeatures->data[i20 + anchorFeatures->size[0] * ((int)
    ...
    if (!(nx == 0)) {
      ...
      if (anchorFeatures->data[(ii_data[(int)fixedFeatureIdx - 1] +
        ...
        //  oldest anchor to 0
        i20 = depthUncertainties->size[0];
        depthUncertainties->size[0] = (int)b_VIOParameters.num_points_per_anchor;
        emxEnsureCapacity((emxArray__common *)depthUncertainties, i20, (int)
                          sizeof(double));
        loop_ub = (int)b_VIOParameters.num_points_per_anchor;
        for (i20 = 0; i20 < loop_ub; i20++) {
          depthUncertainties->data[i20] = 0.0;
        }
        ...
        fixedFeatureIdx = nx;
        loop_ub = P_apr->size[1];
        i20 = (int)(((numStates + (oldestAnchorIdx - 1.0) * (6.0 +
          b_VIOParameters.num_points_per_anchor)) + 6.0) + fixedFeatureIdx);
        for (i21 = 0; i21 < loop_ub; i21++) {
          P_apr->data[(i20 + P_apr->size[0] * i21) - 1] = 0.0;
        }
        ...
        i20 = (int)(((numStates + (oldestAnchorIdx - 1.0) * (6.0 +
          b_VIOParameters.num_points_per_anchor)) + 6.0) + fixedFeatureIdx);
        for (i21 = 0; i21 < loop_ub; i21++) {
          P_apr->data[i21 + P_apr->size[0] * (i20 - 1)] = 0.0;
        }

        d3 = rt_roundd_snf(fixedFeatureIdx);
        if (d3 < 128.0) {
          if (d3 >= -128.0) {
            i22 = (signed char)d3;
          } else {
        ...
        d3 = rt_roundd_snf(oldestAnchorIdx);
        if (d3 < 128.0) {
          if (d3 >= -128.0) {
            i23 = (signed char)d3;
          } else {
  ...
  // % do the update
  i20 = r6->size[0] * r6->size[1];
  r6->size[0] = 24;
  r6->size[1] = anchorFeatures->size[1];
  emxEnsureCapacity((emxArray__common *)r6, i20, (int)sizeof(boolean_T));
  loop_ub = anchorFeatures->size[0] * anchorFeatures->size[1];
  for (i20 = 0; i20 < loop_ub; i20++) {
    r6->data[i20] = (anchorFeatures->data[i20] == 1.0);
  }
  ...
  if (!(i24 == 0)) {
    ...
    for (i20 = 0; i20 < loop_ub; i20++) {
      ii_data[i20] = indMeas_data[i20];
    }

    for (i20 = 0; i20 < loop_ub; i20++) {
      updateVect[ii_data[i20] - 1] = 0.0;
    }

    loop_ub = validFeatures_size[0];
    for (i20 = 0; i20 < loop_ub; i20++) {
      ii_data[i20] = (int)validFeatures_data[i20];
    }

    loop_ub = validFeatures_size[0];
    for (i20 = 0; i20 < loop_ub; i20++) {
      updateVect[ii_data[i20] - 1] = 1.0;
    }
    ...
    while (i <= (int)numTrackFeatures - 1) {
      ...
      if ((!(anchorIdx->size[1] == 0)) && (updateVect[i] != 1.0)) {
        n = 0;
        i20 = c_anchorIdx->size[0];
        c_anchorIdx->size[0] = anchorIdx->size[1];
        emxEnsureCapacity((emxArray__common *)c_anchorIdx, i20, (int)sizeof
                          (double));
        loop_ub = anchorIdx->size[1];
        for (i20 = 0; i20 < loop_ub; i20++) {
          c_anchorIdx->data[i20] = anchorIdx->data[anchorIdx->size[0] * i20];
        }

        i20 = (i + 1) * c_anchorIdx->size[0];
        for (nx = 0; nx < i20; nx++) {
          i21 = r5->size[0];
          r5->size[0] = anchorIdx->size[1];
          emxEnsureCapacity((emxArray__common *)r5, i21, (int)sizeof(int));
  ...
  if (any(x)) {
    ...
    while ((!exitg6) && (ixstart <= (int)numAnchors - 1)) {
      for (i20 = 0; i20 < 24; i20++) {
        x[i20] = ((anchorFeatures->data[i20 + anchorFeatures->size[0] * ixstart]
                   == 1.0) && (updateVect[i20] == 1.0));
      }
    ...
    if (initializeNewAnchor > 0.0) {
      ...
      for (i20 = 0; i20 < nx; i20++) {
        for (i21 = 0; i21 < 3; i21++) {
          m_vect->data[i21 + m_vect->size[0] * (ii_data[i20] - 1)] = rtNaN;
        }
      }

      for (i20 = 0; i20 < 24; i20++) {
        anchorFeatures->data[i20 + anchorFeatures->size[0] * ((int)
      ...
      d3 = numStatesxt + (initializeNewAnchor - 1.0) * (7.0 +
        b_VIOParameters.num_points_per_anchor);
      for (i20 = 0; i20 < 7; i20++) {
        c_xt[i20] = b_xt->data[i20];
      }

      for (i20 = 0; i20 < 7; i20++) {
        b_xt->data[(int)(d3 + (1.0 + (double)i20)) - 1] = c_xt[i20];
      }

      i20 = depthUncertainties->size[0];
      depthUncertainties->size[0] = (int)b_VIOParameters.num_points_per_anchor;
      emxEnsureCapacity((emxArray__common *)depthUncertainties, i20, (int)sizeof
                        (double));
      loop_ub = (int)b_VIOParameters.num_points_per_anchor;
      for (i20 = 0; i20 < loop_ub; i20++) {
        depthUncertainties->data[i20] = 0.0;
      ...
      emxEnsureCapacity((emxArray__common *)r7, i20, (int)sizeof(boolean_T));
      loop_ub = anchorFeatures->size[0] * anchorFeatures->size[1];
      for (i20 = 0; i20 < loop_ub; i20++) {
        r7->data[i20] = (anchorFeatures->data[i20] == 1.0);
      }
      ...
      featureAnchorIdx = 1U;
      idx = 0;
      while ((idx <= ii_size_idx_0 - 1) && (!(featureAnchorIdx >
               numPointsPerAnchor))) {
        ixstart = (indMeas_data[idx] - 1) * 2;
        nx = (indMeas_data[idx] - 1) * 2;
        for (i20 = 0; i20 < 2; i20++) {
          z_curr_l[i20] = z_all_l[ixstart + i20];
          z_curr_r[i20] = z_all_r[nx + i20];
        }

        initializePoint(c_cameraParams_CameraParameters,
                        d_cameraParams_CameraParameters,
        ...
        if (c_any(bv1)) {
          updateVect[indMeas_data[idx] - 1] = 0.0;
          i20 = (int)rt_roundd_snf((double)indMeas_data[idx]);
          i22 = (signed char)i20;
          d_fprintf(i22);
        } else {
          //  check reprojection error
          predictMeasurement_stereo(fp, c_cameraParams_CameraParameters,
          ...
          if (c_norm(b_h_u_l) > 10.0) {
            ...
            if (c_norm(b_h_u_l) > 10.0) {
              ...
              for (i20 = 0; i20 < 3; i20++) {
                m_vect->data[i20 + m_vect->size[0] * (indMeas_data[idx] - 1)] =
                  m[i20];
              }
              ...
              anchorFeatures->data[(indMeas_data[idx] + anchorFeatures->size[0] *
                                    ((int)initializeNewAnchor - 1)) - 1] = 1.0;
              updateVect[indMeas_data[idx] - 1] = 1.0;
              featureAnchorIdx++;
            }
          }
      ...
      h_fprintf(i20, (int)initializeNewAnchor);
      ...
      loop_ub = anchorIdx->size[1];
      for (i20 = 0; i20 < loop_ub; i20++) {
        r5->data[i20] = (int)(d3 + anchorIdx->data[anchorIdx->size[0] * i20]);
      }
      ...
      for (i20 = 0; i20 < loop_ub; i20++) {
        for (i21 = 0; i21 < unnamed_idx_0; i21++) {
          J->data[(r5->data[i21] + J->size[0] * i20) - 1] = 0.0;
        }
      }
      ...
      for (i20 = 0; i20 < 3; i20++) {
        for (i21 = 0; i21 < 3; i21++) {
          J->data[r5->data[i21] + J->size[0] * i20] = iv5[i21 + 3 * i20];
        }
      }

      for (i20 = 0; i20 < 3; i20++) {
        for (i21 = 0; i21 < 3; i21++) {
          J->data[r5->data[i21] + J->size[0] * (i20 + 3)] = 0.0;
        }
      }
      ...
      for (i20 = 0; i20 < loop_ub; i20++) {
        for (i21 = 0; i21 < 3; i21++) {
          J->data[r5->data[i21] + J->size[0] * (i20 + 6)] = 0.0;
        }
      }

      for (i20 = 0; i20 < 3; i20++) {
        for (i21 = 0; i21 < 3; i21++) {
          J->data[r5->data[i21 + 3] + J->size[0] * i20] = 0.0;
        }
      }

      for (i20 = 0; i20 < 3; i20++) {
        for (i21 = 0; i21 < 3; i21++) {
          J->data[r5->data[i21 + 3] + J->size[0] * (i20 + 3)] = iv5[i21 + 3 *
            i20];
        }
      }
      ...
      for (i20 = 0; i20 < loop_ub; i20++) {
        for (i21 = 0; i21 < 3; i21++) {
          J->data[r5->data[i21 + 3] + J->size[0] * (i20 + 6)] = 0.0;
        }
      }
      ...
      for (i20 = 0; i20 < loop_ub; i20++) {
        ...
        for (i21 = 0; i21 < ixstart; i21++) {
          J->data[r5->data[i21 + 6] + J->size[0] * i20] = 0.0;
        }
      }
      ...
      if ((J->size[1] == 1) || (P_apr->size[0] == 1)) {
        ...
        for (i20 = 0; i20 < loop_ub; i20++) {
          ...
          for (i21 = 0; i21 < ixstart; i21++) {
            ...
            idx = J->size[1];
            for (n = 0; n < idx; n++) {
              y->data[i20 + y->size[0] * i21] += J->data[i20 + J->size[0] * n] *
                P_apr->data[n + P_apr->size[0] * i21];
            }
          }
        }
      } else {
      ...
      for (i20 = 0; i20 < loop_ub; i20++) {
        ixstart = J->size[1];
        for (i21 = 0; i21 < ixstart; i21++) {
          b->data[i21 + b->size[0] * i20] = J->data[i20 + J->size[0] * i21];
        }
      }

      emxFree_real_T(&J);
      if ((y->size[1] == 1) || (b->size[0] == 1)) {
        i20 = P_apr->size[0] * P_apr->size[1];
        P_apr->size[0] = y->size[0];
        P_apr->size[1] = b->size[1];
        emxEnsureCapacity((emxArray__common *)P_apr, i20, (int)sizeof(double));
        loop_ub = y->size[0];
        for (i20 = 0; i20 < loop_ub; i20++) {
          ixstart = b->size[1];
          for (i21 = 0; i21 < ixstart; i21++) {
            P_apr->data[i20 + P_apr->size[0] * i21] = 0.0;
            idx = y->size[1];
            for (n = 0; n < idx; n++) {
              P_apr->data[i20 + P_apr->size[0] * i21] += y->data[i20 + y->size[0]
                * n] * b->data[n + b->size[0] * i21];
            }
          }
        }
      } else {
        ...
        for (i20 = 0; i20 < ixstart; i20++) {
          for (i21 = 0; i21 < unnamed_idx_0; i21++) {
            P_apr->data[i21 + P_apr->size[0] * i20] = 0.0;
          }
        }
      ...
      if (b_VIOParameters.fixed_anchor) {
        ...
        i20 = anchorAges->size[0];
        emxEnsureCapacity((emxArray__common *)anchorAges, i20, (int)sizeof
                          (double));
        ...
        if (oldestAnchorIdx != nx) {
          ...
          for (i20 = 0; i20 < loop_ub; i20++) {
            for (i21 = 0; i21 < 3; i21++) {
              P_apr->data[((int)(d3 + (1.0 + (double)i21)) + P_apr->size[0] *
                           i20) - 1] = 0.0;
            }
          }
          ...
          for (i20 = 0; i20 < 3; i20++) {
            for (i21 = 0; i21 < loop_ub; i21++) {
              P_apr->data[i21 + P_apr->size[0] * ((int)(d3 + (1.0 + (double)i20))
                - 1)] = 0.0;
            }
          }

          //                  P_anchor_att_world = R_cw' * P_apo(numStates + (oldestAnchorIdx-1)*numStatesPerAnchor + (4:6), numStates + (oldestAnchorIdx-1)*numStatesPerAnchor + (4:6)) * R_cw; 
          //                  P_anchor_att_world(3,:) = 0; % set the yaw uncertainty to 0 
          //                  P_anchor_att_world(:,3) = 0;
          //                  P_apo(numStates + (oldestAnchorIdx-1)*numStatesPerAnchor + (4:6), numStates + (oldestAnchorIdx-1)*numStatesPerAnchor + (4:6)) = P_anchor_att_world; 
  ...
  if (minNumValidFeatures < minFeatureThreshold) {
    ...
    while ((!exitg1) && (i < 24)) {
      ...
      r8->size[0] = 1;
      r8->size[1] = loop_ub;
      emxEnsureCapacity((emxArray__common *)r8, i20, (int)sizeof(boolean_T));
      for (i20 = 0; i20 < loop_ub; i20++) {
        r8->data[r8->size[0] * i20] = (anchorFeatures->data[i +
          anchorFeatures->size[0] * i20] == 1.0);
      }
  ...
  for (i = 0; i < 24; i++) {
    ...
    r9->size[0] = 1;
    r9->size[1] = loop_ub;
    emxEnsureCapacity((emxArray__common *)r9, i20, (int)sizeof(boolean_T));
    for (i20 = 0; i20 < loop_ub; i20++) {
      r9->data[r9->size[0] * i20] = (anchorFeatures->data[i +
        anchorFeatures->size[0] * i20] == 1.0);
    }

    if (d_any(r9)) {
      for (i20 = 0; i20 < 3; i20++) {
        b_map[i20] = map->data[i20 + map->size[0] * i] - b_xt->data[i20];
      }

      for (i20 = 0; i20 < 3; i20++) {
        b_R_cw[i20] = 0.0;
        for (i21 = 0; i21 < 3; i21++) {
          b_R_cw[i20] += R_cw[i20 + 3 * i21] * b_map[i21];
        }
      }
      ...
      ixstart = i << 2;
      for (i20 = 0; i20 < 2; i20++) {
        h_u_apo->data[i20 + ixstart] = h_u_l[i20];
      }

      for (i20 = 0; i20 < 2; i20++) {
        h_u_apo->data[(i20 + ixstart) + 2] = h_u_r[i20];
      }
    }
  }
