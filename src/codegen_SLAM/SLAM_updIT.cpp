                ...
                emxArray_real_T *h_u_apo, emxArray_real_T *map)
{
  ...
  while (i <= (int)c_numTrackFeatures - 1) {
    ...
    if ((!(anchorIdx->size[1] == 0)) && (updateVect[i] != 1.0)) {
      ...
      for (k = 0; k < i13; k++) {
        ...
        emxEnsureCapacity((emxArray__common *)r6, i14, (int)sizeof(int));
        loop_ub = anchorIdx->size[1];
        for (i14 = 0; i14 < loop_ub; i14++) {
          r6->data[i14] = (int)anchorIdx->data[anchorIdx->size[0] * i14];
        }
      ...
      loop_ub = anchorIdx->size[1];
      for (i13 = 0; i13 < loop_ub; i13++) {
        r6->data[i13] = (int)(((numStates + (anchorIdx->data[anchorIdx->size[0] *
      ...
      for (i13 = 0; i13 < loop_ub; i13++) {
        for (i14 = 0; i14 < unnamed_idx_0; i14++) {
          P_apr->data[(r6->data[i14] + P_apr->size[0] * i13) - 1] = 0.0;
        }
      }
      ...
      for (i13 = 0; i13 < nm1d2; i13++) {
        for (i14 = 0; i14 < loop_ub; i14++) {
          P_apr->data[i14 + P_apr->size[0] * (r6->data[i13] - 1)] = 0.0;
        }
      }
      ...
      nm1d2 = r6->size[0];
      for (i13 = 0; i13 < nm1d2; i13++) {
        anchorFeatures->data[i + anchorFeatures->size[0] * (r6->data[i13] - 1)] =
          -1.0;
      }
  ...
  for (i13 = 0; i13 < loop_ub; i13++) {
    r7->data[i13] = (anchorFeatures->data[i13] == 1.0);
  }
  ...
  if (any(b_x)) {
    ...
    if (initializeNewAnchor > 0.0) {
      ...
      h_fprintf(i13, (int)initializeNewAnchor);
      ...
      loop_ub = anchorIdx->size[1];
      for (i13 = 0; i13 < loop_ub; i13++) {
        r6->data[i13] = (int)(anew + anchorIdx->data[anchorIdx->size[0] * i13]);
      }
      ...
      for (i13 = 0; i13 < loop_ub; i13++) {
        for (i14 = 0; i14 < unnamed_idx_0; i14++) {
          J->data[(r6->data[i14] + J->size[0] * i13) - 1] = 0.0;
        }
      }
      ...
      for (i13 = 0; i13 < 3; i13++) {
        for (i14 = 0; i14 < 3; i14++) {
          J->data[r6->data[i14] + J->size[0] * i13] = iv9[i14 + 3 * i13];
        }
      }

      for (i13 = 0; i13 < 3; i13++) {
        for (i14 = 0; i14 < 3; i14++) {
          J->data[r6->data[i14] + J->size[0] * (i13 + 3)] = 0.0;
        }
      }
      ...
      for (i13 = 0; i13 < loop_ub; i13++) {
        for (i14 = 0; i14 < 3; i14++) {
          J->data[r6->data[i14] + J->size[0] * (i13 + 6)] = 0.0;
        }
      }

      for (i13 = 0; i13 < 3; i13++) {
        for (i14 = 0; i14 < 3; i14++) {
          J->data[r6->data[i14 + 3] + J->size[0] * i13] = 0.0;
        }
      }

      for (i13 = 0; i13 < 3; i13++) {
        for (i14 = 0; i14 < 3; i14++) {
          J->data[r6->data[i14 + 3] + J->size[0] * (i13 + 3)] = iv9[i14 + 3 *
            i13];
        }
      }
      ...
      for (i13 = 0; i13 < loop_ub; i13++) {
        for (i14 = 0; i14 < 3; i14++) {
          J->data[r6->data[i14 + 3] + J->size[0] * (i13 + 6)] = 0.0;
        }
      }
      ...
      for (i13 = 0; i13 < loop_ub; i13++) {
        ...
        for (i14 = 0; i14 < nm1d2; i14++) {
          J->data[r6->data[i14 + 6] + J->size[0] * i13] = 0.0;
        }
      }
  ...
  if (minNumValidFeatures < minFeatureThreshold) {
    ...
    while ((!exitg1) && (i < 16)) {
      ...
      for (i13 = 0; i13 < loop_ub; i13++) {
        r9->data[r9->size[0] * i13] = (anchorFeatures->data[i +
          anchorFeatures->size[0] * i13] == 1.0);
      }
