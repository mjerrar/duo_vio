                ...
                emxArray_real_T *map)
{
  ...
  //  debug check
  i19 = r4->size[0] * r4->size[1];
  r4->size[0] = 24;
  r4->size[1] = anchorFeatures->size[1];
  emxEnsureCapacity((emxArray__common *)r4, i19, (int)sizeof(boolean_T));
  loop_ub = anchorFeatures->size[0] * anchorFeatures->size[1];
  for (i19 = 0; i19 < loop_ub; i19++) {
    r4->data[i19] = (anchorFeatures->data[i19] == 1.0);
  }
  ...
  while (i <= (int)numTrackFeatures - 1) {
    ...
    i19 = b_x->size[0] * b_x->size[1];
    b_x->size[0] = 1;
    b_x->size[1] = loop_ub;
    emxEnsureCapacity((emxArray__common *)b_x, i19, (int)sizeof(boolean_T));
    for (i19 = 0; i19 < loop_ub; i19++) {
      b_x->data[b_x->size[0] * i19] = (anchorFeatures->data[i +
        anchorFeatures->size[0] * i19] == 1.0);
    }

    nx = b_x->size[1];
    idx = 0;
    i19 = ii->size[0] * ii->size[1];
    ii->size[0] = 1;
    ...
    for (i19 = 0; i19 < loop_ub; i19++) {
      anchorIdx->data[i19] = ii->data[i19];
    }
    ...
    if ((!(anchorIdx->size[1] == 0)) && (updateVect[i] != 1.0)) {
      ...
      loop_ub = anchorIdx->size[1];
      for (i19 = 0; i19 < loop_ub; i19++) {
        r5->data[i19] = (int)(((numStates + (anchorIdx->data[anchorIdx->size[0] *
          i19] - 1.0) * numStatesPerAnchor) + 6.0) + (double)n);
      }
      ...
      for (i19 = 0; i19 < loop_ub; i19++) {
        for (i20 = 0; i20 < unnamed_idx_0; i20++) {
          P_apr->data[(r5->data[i20] + P_apr->size[0] * i19) - 1] = 0.0;
        }
      }
      ...
      for (i19 = 0; i19 < ixstart; i19++) {
        for (i20 = 0; i20 < loop_ub; i20++) {
          P_apr->data[i20 + P_apr->size[0] * (r5->data[i19] - 1)] = 0.0;
        }
      }
      ...
      ixstart = r5->size[0];
      for (i19 = 0; i19 < ixstart; i19++) {
        anchorFeatures->data[i + anchorFeatures->size[0] * (r5->data[i19] - 1)] =
          -1.0;
      }
  ...
  if (b_VIOParameters.fixed_anchor && (fixedFeatureIdx != 0.0)) {
    ...
    for (i19 = 0; i19 < 24; i19++) {
      x[i19] = (anchorFeatures->data[i19 + anchorFeatures->size[0] * ((int)
    ...
    if (!(nx == 0)) {
      ...
      if (anchorFeatures->data[(ii_data[(int)fixedFeatureIdx - 1] +
        ...
        //  oldest anchor to 0
        i19 = depthUncertainties->size[0];
        depthUncertainties->size[0] = (int)b_VIOParameters.num_points_per_anchor;
        emxEnsureCapacity((emxArray__common *)depthUncertainties, i19, (int)
                          sizeof(double));
        loop_ub = (int)b_VIOParameters.num_points_per_anchor;
        for (i19 = 0; i19 < loop_ub; i19++) {
          depthUncertainties->data[i19] = 0.0;
        }
        ...
        fixedFeatureIdx = nx;
        loop_ub = P_apr->size[1];
        i19 = (int)(((numStates + (oldestAnchorIdx - 1.0) * (6.0 +
          b_VIOParameters.num_points_per_anchor)) + 6.0) + fixedFeatureIdx);
        for (i20 = 0; i20 < loop_ub; i20++) {
          P_apr->data[(i19 + P_apr->size[0] * i20) - 1] = 0.0;
        }
        ...
        i19 = (int)(((numStates + (oldestAnchorIdx - 1.0) * (6.0 +
          b_VIOParameters.num_points_per_anchor)) + 6.0) + fixedFeatureIdx);
        for (i20 = 0; i20 < loop_ub; i20++) {
          P_apr->data[i20 + P_apr->size[0] * (i19 - 1)] = 0.0;
        }
  ...
  if (!(i21 == 0)) {
    ...
    for (i19 = 0; i19 < loop_ub; i19++) {
      ii_data[i19] = indMeas_data[i19];
    }

    for (i19 = 0; i19 < loop_ub; i19++) {
      updateVect[ii_data[i19] - 1] = 0.0;
    }

    loop_ub = validFeatures_size[0];
    for (i19 = 0; i19 < loop_ub; i19++) {
      ii_data[i19] = (int)validFeatures_data[i19];
    }

    loop_ub = validFeatures_size[0];
    for (i19 = 0; i19 < loop_ub; i19++) {
      updateVect[ii_data[i19] - 1] = 1.0;
    }
    ...
    while (i <= (int)numTrackFeatures - 1) {
      ...
      if ((!(anchorIdx->size[1] == 0)) && (updateVect[i] != 1.0)) {
        n = 0;
        i19 = c_anchorIdx->size[0];
        c_anchorIdx->size[0] = anchorIdx->size[1];
        emxEnsureCapacity((emxArray__common *)c_anchorIdx, i19, (int)sizeof
                          (double));
        loop_ub = anchorIdx->size[1];
        for (i19 = 0; i19 < loop_ub; i19++) {
          c_anchorIdx->data[i19] = anchorIdx->data[anchorIdx->size[0] * i19];
        }

        i19 = (i + 1) * c_anchorIdx->size[0];
        for (nx = 0; nx < i19; nx++) {
          i20 = r5->size[0];
          r5->size[0] = anchorIdx->size[1];
          emxEnsureCapacity((emxArray__common *)r5, i20, (int)sizeof(int));
  ...
  if (any(x)) {
    ...
    while ((!exitg6) && (ixstart <= (int)numAnchors - 1)) {
      for (i19 = 0; i19 < 24; i19++) {
        x[i19] = ((anchorFeatures->data[i19 + anchorFeatures->size[0] * ixstart]
                   == 1.0) && (updateVect[i19] == 1.0));
      }
    ...
    if (initializeNewAnchor > 0.0) {
      ...
      for (i19 = 0; i19 < nx; i19++) {
        for (i20 = 0; i20 < 3; i20++) {
          m_vect->data[i20 + m_vect->size[0] * (ii_data[i19] - 1)] = rtNaN;
        }
      }

      for (i19 = 0; i19 < 24; i19++) {
        anchorFeatures->data[i19 + anchorFeatures->size[0] * ((int)
      ...
      for (i19 = 0; i19 < 7; i19++) {
        b_xt->data[(int)(d3 + (1.0 + (double)i19)) - 1] = c_xt[i19];
      }

      i19 = depthUncertainties->size[0];
      depthUncertainties->size[0] = (int)b_VIOParameters.num_points_per_anchor;
      emxEnsureCapacity((emxArray__common *)depthUncertainties, i19, (int)sizeof
                        (double));
      loop_ub = (int)b_VIOParameters.num_points_per_anchor;
      for (i19 = 0; i19 < loop_ub; i19++) {
        depthUncertainties->data[i19] = 0.0;
      ...
      emxEnsureCapacity((emxArray__common *)r7, i19, (int)sizeof(boolean_T));
      loop_ub = anchorFeatures->size[0] * anchorFeatures->size[1];
      for (i19 = 0; i19 < loop_ub; i19++) {
        r7->data[i19] = (anchorFeatures->data[i19] == 1.0);
      }
      ...
      while ((unusedFeatureIdx <= ii_size_idx_0 - 1) && (!(featureAnchorIdx >
        ...
        for (i19 = 0; i19 < 2; i19++) {
          z_curr_l[i19] = z_all_l[ixstart + i19];
        ...
        if (c_any(bv1)) {
          ...
          i19 = (int)rt_roundd_snf((double)indMeas_data[unusedFeatureIdx]);
          i22 = (signed char)i19;
          b_fprintf(i22);
        } else {
          ...
          if (c_norm(b_h_u_l) > 10.0) {
            ...
            if (c_norm(b_h_u_l) > 10.0) {
              ...
              for (i19 = 0; i19 < 3; i19++) {
                m_vect->data[i19 + m_vect->size[0] *
                  (indMeas_data[unusedFeatureIdx] - 1)] = m[i19];
              }
      ...
      f_fprintf(i19, (int)initializeNewAnchor);
      ...
      loop_ub = anchorIdx->size[1];
      for (i19 = 0; i19 < loop_ub; i19++) {
        r5->data[i19] = (int)(d3 + anchorIdx->data[anchorIdx->size[0] * i19]);
      }
      ...
      for (i19 = 0; i19 < loop_ub; i19++) {
        for (i20 = 0; i20 < unnamed_idx_0; i20++) {
          J->data[(r5->data[i20] + J->size[0] * i19) - 1] = 0.0;
        }
      }
      ...
      for (i19 = 0; i19 < 3; i19++) {
        for (i20 = 0; i20 < 3; i20++) {
          J->data[r5->data[i20] + J->size[0] * i19] = iv5[i20 + 3 * i19];
        }
      }

      for (i19 = 0; i19 < 3; i19++) {
        for (i20 = 0; i20 < 3; i20++) {
          J->data[r5->data[i20] + J->size[0] * (i19 + 3)] = 0.0;
        }
      }
      ...
      for (i19 = 0; i19 < loop_ub; i19++) {
        for (i20 = 0; i20 < 3; i20++) {
          J->data[r5->data[i20] + J->size[0] * (i19 + 6)] = 0.0;
        }
      }

      for (i19 = 0; i19 < 3; i19++) {
        for (i20 = 0; i20 < 3; i20++) {
          J->data[r5->data[i20 + 3] + J->size[0] * i19] = 0.0;
        }
      }

      for (i19 = 0; i19 < 3; i19++) {
        for (i20 = 0; i20 < 3; i20++) {
          J->data[r5->data[i20 + 3] + J->size[0] * (i19 + 3)] = iv5[i20 + 3 *
            i19];
        }
      }
      ...
      for (i19 = 0; i19 < loop_ub; i19++) {
        for (i20 = 0; i20 < 3; i20++) {
          J->data[r5->data[i20 + 3] + J->size[0] * (i19 + 6)] = 0.0;
        }
      }
      ...
      for (i19 = 0; i19 < loop_ub; i19++) {
        ...
        for (i20 = 0; i20 < ixstart; i20++) {
          J->data[r5->data[i20 + 6] + J->size[0] * i19] = 0.0;
        }
      }
      ...
      if ((J->size[1] == 1) || (P_apr->size[0] == 1)) {
        ...
        for (i19 = 0; i19 < loop_ub; i19++) {
          ...
          for (i20 = 0; i20 < ixstart; i20++) {
            ...
            idx = J->size[1];
            for (n = 0; n < idx; n++) {
              y->data[i19 + y->size[0] * i20] += J->data[i19 + J->size[0] * n] *
                P_apr->data[n + P_apr->size[0] * i20];
            }
          }
        }
      } else {
      ...
      if ((y->size[1] == 1) || (b->size[0] == 1)) {
        ...
        for (i19 = 0; i19 < ixstart; i19++) {
          for (i20 = 0; i20 < unnamed_idx_0; i20++) {
            P_apr->data[i20 + P_apr->size[0] * i19] = 0.0;
          }
        }
      ...
      if (b_VIOParameters.fixed_anchor) {
        ...
        i19 = anchorAges->size[0];
        emxEnsureCapacity((emxArray__common *)anchorAges, i19, (int)sizeof
                          (double));
        ...
        if (oldestAnchorIdx != nx) {
          ...
          for (i19 = 0; i19 < loop_ub; i19++) {
            for (i20 = 0; i20 < 3; i20++) {
              P_apr->data[((int)(d3 + (1.0 + (double)i20)) + P_apr->size[0] *
                           i19) - 1] = 0.0;
            }
          }
          ...
          for (i19 = 0; i19 < 3; i19++) {
            for (i20 = 0; i20 < loop_ub; i20++) {
              P_apr->data[i20 + P_apr->size[0] * ((int)(d3 + (1.0 + (double)i19))
                - 1)] = 0.0;
            }
          }
  ...
  if (minNumValidFeatures < minFeatureThreshold) {
    ...
    while ((!exitg1) && (i < 24)) {
      loop_ub = anchorFeatures->size[1];
      i19 = r8->size[0] * r8->size[1];
      r8->size[0] = 1;
      r8->size[1] = loop_ub;
      emxEnsureCapacity((emxArray__common *)r8, i19, (int)sizeof(boolean_T));
      for (i19 = 0; i19 < loop_ub; i19++) {
        r8->data[r8->size[0] * i19] = (anchorFeatures->data[i +
          anchorFeatures->size[0] * i19] == 1.0);
      }
  ...
  for (i = 0; i < 24; i++) {
    ...
    r9->size[0] = 1;
    r9->size[1] = loop_ub;
    emxEnsureCapacity((emxArray__common *)r9, i19, (int)sizeof(boolean_T));
    for (i19 = 0; i19 < loop_ub; i19++) {
      r9->data[r9->size[0] * i19] = (anchorFeatures->data[i +
        anchorFeatures->size[0] * i19] == 1.0);
    }
    ...
    if (d_any(r9)) {
      ...
      ixstart = i << 2;
      for (i19 = 0; i19 < 2; i19++) {
        h_u_apo->data[i19 + ixstart] = h_u_l[i19];
      }

      for (i19 = 0; i19 < 2; i19++) {
        h_u_apo->data[(i19 + ixstart) + 2] = h_u_r[i19];
      }
    }
  }
