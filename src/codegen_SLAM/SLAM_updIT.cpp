                ...
                emxArray_real_T *map)
{
  ...
  for (i14 = 0; i14 < loop_ub; i14++) {
    r11->data[i14] = (anchorFeatures->data[i14] == 1.0);
  }
  ...
  while (i <= (int)c_numTrackFeatures - 1) {
    ...
    if ((!(anchorIdx->size[1] == 0)) && (updateVect[i] != 1.0)) {
      ...
      loop_ub = anchorIdx->size[1];
      for (i14 = 0; i14 < loop_ub; i14++) {
        r12->data[i14] = (int)(((numStates + (anchorIdx->data[anchorIdx->size[0]
      ...
      for (i14 = 0; i14 < loop_ub; i14++) {
        for (i15 = 0; i15 < unnamed_idx_0; i15++) {
          P_apr->data[(r12->data[i15] + P_apr->size[0] * i14) - 1] = 0.0;
        }
      }
      ...
      for (i14 = 0; i14 < ixstart; i14++) {
        for (i15 = 0; i15 < loop_ub; i15++) {
          P_apr->data[i15 + P_apr->size[0] * (r12->data[i14] - 1)] = 0.0;
        }
      }
      ...
      ixstart = r12->size[0];
      for (i14 = 0; i14 < ixstart; i14++) {
        anchorFeatures->data[i + anchorFeatures->size[0] * (r12->data[i14] - 1)]
          = -1.0;
      }
  ...
  if (!(i16 == 0)) {
    ...
    while (i <= (int)c_numTrackFeatures - 1) {
      ...
      if ((!(anchorIdx->size[1] == 0)) && (updateVect[i] != 1.0)) {
        ...
        loop_ub = anchorIdx->size[1];
        for (i14 = 0; i14 < loop_ub; i14++) {
          r12->data[i14] = (int)(((numStates + (anchorIdx->data[anchorIdx->size
  ...
  if (any(x)) {
    ...
    if (initializeNewAnchor > 0.0) {
      ...
      d4 = numStatesxt + (initializeNewAnchor - 1.0) * (7.0 +
        b_VIOParameters.num_points_per_anchor);
      for (i14 = 0; i14 < 7; i14++) {
      ...
      for (i14 = 0; i14 < 7; i14++) {
        b_xt->data[(int)(d4 + (1.0 + (double)i14)) - 1] = c_xt[i14];
      }
      ...
      loop_ub = anchorFeatures->size[0] * anchorFeatures->size[1];
      for (i14 = 0; i14 < loop_ub; i14++) {
        r14->data[i14] = (anchorFeatures->data[i14] == 1.0);
      }
      ...
      d4 = rt_roundd_snf((double)featureAnchorIdx - 1.0);
      ...
      d4 = numStates + (initializeNewAnchor - 1.0) * (6.0 +
        b_VIOParameters.num_points_per_anchor);
      i14 = r12->size[0];
      r12->size[0] = anchorIdx->size[1];
      emxEnsureCapacity((emxArray__common *)r12, i14, (int)sizeof(int));
      loop_ub = anchorIdx->size[1];
      for (i14 = 0; i14 < loop_ub; i14++) {
        r12->data[i14] = (int)(d4 + anchorIdx->data[anchorIdx->size[0] * i14]);
      }
      ...
      for (i14 = 0; i14 < loop_ub; i14++) {
        for (i15 = 0; i15 < unnamed_idx_0; i15++) {
          J->data[(r12->data[i15] + J->size[0] * i14) - 1] = 0.0;
        }
      }
      ...
      for (i14 = 0; i14 < 3; i14++) {
        for (i15 = 0; i15 < 3; i15++) {
          J->data[r12->data[i15] + J->size[0] * i14] = iv12[i15 + 3 * i14];
        }
      }

      for (i14 = 0; i14 < 3; i14++) {
        for (i15 = 0; i15 < 3; i15++) {
          J->data[r12->data[i15] + J->size[0] * (i14 + 3)] = 0.0;
        }
      }
      ...
      for (i14 = 0; i14 < loop_ub; i14++) {
        for (i15 = 0; i15 < 3; i15++) {
          J->data[r12->data[i15] + J->size[0] * (i14 + 6)] = 0.0;
        }
      }

      for (i14 = 0; i14 < 3; i14++) {
        for (i15 = 0; i15 < 3; i15++) {
          J->data[r12->data[i15 + 3] + J->size[0] * i14] = 0.0;
        }
      }

      for (i14 = 0; i14 < 3; i14++) {
        for (i15 = 0; i15 < 3; i15++) {
          J->data[r12->data[i15 + 3] + J->size[0] * (i14 + 3)] = iv12[i15 + 3 *
            i14];
        }
      }
      ...
      for (i14 = 0; i14 < loop_ub; i14++) {
        for (i15 = 0; i15 < 3; i15++) {
          J->data[r12->data[i15 + 3] + J->size[0] * (i14 + 6)] = 0.0;
        }
      }
      ...
      for (i14 = 0; i14 < loop_ub; i14++) {
        ...
        for (i15 = 0; i15 < ixstart; i15++) {
          J->data[r12->data[i15 + 6] + J->size[0] * i14] = 0.0;
        }
      }
      ...
      if (b_VIOParameters.fixed_anchor) {
        ...
        if (oldestAnchorIdx != nx) {
          ...
          for (i14 = 0; i14 < loop_ub; i14++) {
            for (i15 = 0; i15 < 3; i15++) {
              P_apr->data[((int)(d4 + (1.0 + (double)i15)) + P_apr->size[0] *
                           i14) - 1] = 0.0;
            }
          }
          ...
          for (i14 = 0; i14 < 3; i14++) {
            for (i15 = 0; i15 < loop_ub; i15++) {
              P_apr->data[i15 + P_apr->size[0] * ((int)(d4 + (1.0 + (double)i14))
                - 1)] = 0.0;
            }
          }
  ...
  for (i = 0; i < 16; i++) {
    ...
    r16->size[0] = 1;
    r16->size[1] = loop_ub;
    emxEnsureCapacity((emxArray__common *)r16, i14, (int)sizeof(boolean_T));
    for (i14 = 0; i14 < loop_ub; i14++) {
      r16->data[r16->size[0] * i14] = (anchorFeatures->data[i +
        anchorFeatures->size[0] * i14] == 1.0);
    }
