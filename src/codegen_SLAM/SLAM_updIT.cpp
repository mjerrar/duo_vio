                ...
                emxArray_real_T *h_u_apo, emxArray_real_T *map)
{
  ...
  if (!m_vect_not_empty) {
    ...
    i11 = anchorAges->size[0];
    anchorAges->size[0] = (int)b_VIOParameters.num_anchors;
    emxEnsureCapacity((emxArray__common *)anchorAges, i11, (int)sizeof(double));
    loop_ub = (int)b_VIOParameters.num_anchors;
    for (i11 = 0; i11 < loop_ub; i11++) {
      anchorAges->data[i11] = 0.0;
    }
  ...
  emxEnsureCapacity((emxArray__common *)r4, i11, (int)sizeof(boolean_T));
  loop_ub = anchorFeatures->size[0] * anchorFeatures->size[1];
  for (i11 = 0; i11 < loop_ub; i11++) {
    r4->data[i11] = (anchorFeatures->data[i11] == 1.0);
  }
  ...
  while (i <= (int)numTrackFeatures - 1) {
    ...
    for (i11 = 0; i11 < loop_ub; i11++) {
      b_x->data[b_x->size[0] * i11] = (anchorFeatures->data[i +
    ...
    if ((!(anchorIdx->size[1] == 0)) && (updateVect[i] != 1.0)) {
      ...
      for (nx = 0; nx < i11; nx++) {
        ...
        emxEnsureCapacity((emxArray__common *)r5, i12, (int)sizeof(int));
        loop_ub = anchorIdx->size[1];
        for (i12 = 0; i12 < loop_ub; i12++) {
          r5->data[i12] = (int)anchorIdx->data[anchorIdx->size[0] * i12];
        }
      ...
      loop_ub = anchorIdx->size[1];
      for (i11 = 0; i11 < loop_ub; i11++) {
        r5->data[i11] = (int)(((numStates + (anchorIdx->data[anchorIdx->size[0] *
          i11] - 1.0) * numStatesPerAnchor) + 6.0) + (double)n);
      }
      ...
      for (i11 = 0; i11 < loop_ub; i11++) {
        for (i12 = 0; i12 < unnamed_idx_0; i12++) {
          P_apr->data[(r5->data[i12] + P_apr->size[0] * i11) - 1] = 0.0;
        }
      }
      ...
      for (i11 = 0; i11 < ixstart; i11++) {
        for (i12 = 0; i12 < loop_ub; i12++) {
          P_apr->data[i12 + P_apr->size[0] * (r5->data[i11] - 1)] = 0.0;
        }
      }
      ...
      loop_ub = anchorIdx->size[1];
      for (i11 = 0; i11 < loop_ub; i11++) {
        r5->data[i11] = (int)anchorIdx->data[anchorIdx->size[0] * i11];
      }

      ixstart = r5->size[0];
      for (i11 = 0; i11 < ixstart; i11++) {
        anchorFeatures->data[i + anchorFeatures->size[0] * (r5->data[i11] - 1)] =
          -1.0;
      }
  ...
  if (b_VIOParameters.fixed_anchor && (fixedFeatureIdx != 0.0)) {
    ...
    for (i11 = 0; i11 < 24; i11++) {
      x[i11] = (anchorFeatures->data[i11 + anchorFeatures->size[0] * ((int)
    ...
    if (!(nx == 0)) {
      ...
      if (anchorFeatures->data[(ii_data[(int)fixedFeatureIdx - 1] +
        ...
        //  oldest anchor to 0
        i11 = depthUncertainties->size[0];
        depthUncertainties->size[0] = (int)b_VIOParameters.num_points_per_anchor;
        emxEnsureCapacity((emxArray__common *)depthUncertainties, i11, (int)
                          sizeof(double));
        loop_ub = (int)b_VIOParameters.num_points_per_anchor;
        for (i11 = 0; i11 < loop_ub; i11++) {
          depthUncertainties->data[i11] = 0.0;
        }
        ...
        fixedFeatureIdx = nx;
        loop_ub = P_apr->size[1];
        i11 = (int)(((numStates + (oldestAnchorIdx - 1.0) * (6.0 +
          b_VIOParameters.num_points_per_anchor)) + 6.0) + fixedFeatureIdx);
        for (i12 = 0; i12 < loop_ub; i12++) {
          P_apr->data[(i11 + P_apr->size[0] * i12) - 1] = 0.0;
        }
        ...
        i11 = (int)(((numStates + (oldestAnchorIdx - 1.0) * (6.0 +
          b_VIOParameters.num_points_per_anchor)) + 6.0) + fixedFeatureIdx);
        for (i12 = 0; i12 < loop_ub; i12++) {
          P_apr->data[i12 + P_apr->size[0] * (i11 - 1)] = 0.0;
        }
  ...
  emxEnsureCapacity((emxArray__common *)r6, i11, (int)sizeof(boolean_T));
  loop_ub = anchorFeatures->size[0] * anchorFeatures->size[1];
  for (i11 = 0; i11 < loop_ub; i11++) {
    r6->data[i11] = (anchorFeatures->data[i11] == 1.0);
  }
  ...
  if (any(x)) {
    ...
    while ((!exitg6) && (ixstart <= (int)numAnchors - 1)) {
      for (i11 = 0; i11 < 24; i11++) {
        x[i11] = ((anchorFeatures->data[i11 + anchorFeatures->size[0] * ixstart]
    ...
    if (initializeNewAnchor > 0.0) {
      ...
      for (i11 = 0; i11 < 7; i11++) {
        b_xt->data[(int)(d3 + (1.0 + (double)i11)) - 1] = c_xt[i11];
      }

      i11 = depthUncertainties->size[0];
      depthUncertainties->size[0] = (int)b_VIOParameters.num_points_per_anchor;
      emxEnsureCapacity((emxArray__common *)depthUncertainties, i11, (int)sizeof
                        (double));
      loop_ub = (int)b_VIOParameters.num_points_per_anchor;
      for (i11 = 0; i11 < loop_ub; i11++) {
        depthUncertainties->data[i11] = 0.0;
      ...
      while ((unusedFeatureIdx <= ii_size_idx_0 - 1) && (!(featureAnchorIdx >
        ...
        for (i11 = 0; i11 < 2; i11++) {
          z_curr_l[i11] = z_all_l[ixstart + i11];
          z_curr_r[i11] = z_all_r[nx + i11];
        }
      ...
      f_fprintf(i11, (int)initializeNewAnchor);
      ...
      loop_ub = anchorIdx->size[1];
      for (i11 = 0; i11 < loop_ub; i11++) {
        r5->data[i11] = (int)(d3 + anchorIdx->data[anchorIdx->size[0] * i11]);
      }
      ...
      for (i11 = 0; i11 < loop_ub; i11++) {
        for (i12 = 0; i12 < unnamed_idx_0; i12++) {
          J->data[(r5->data[i12] + J->size[0] * i11) - 1] = 0.0;
        }
      }
      ...
      for (i11 = 0; i11 < 3; i11++) {
        for (i12 = 0; i12 < 3; i12++) {
          J->data[r5->data[i12] + J->size[0] * i11] = iv5[i12 + 3 * i11];
        }
      }

      for (i11 = 0; i11 < 3; i11++) {
        for (i12 = 0; i12 < 3; i12++) {
          J->data[r5->data[i12] + J->size[0] * (i11 + 3)] = 0.0;
        }
      }
      ...
      for (i11 = 0; i11 < loop_ub; i11++) {
        for (i12 = 0; i12 < 3; i12++) {
          J->data[r5->data[i12] + J->size[0] * (i11 + 6)] = 0.0;
        }
      }

      for (i11 = 0; i11 < 3; i11++) {
        for (i12 = 0; i12 < 3; i12++) {
          J->data[r5->data[i12 + 3] + J->size[0] * i11] = 0.0;
        }
      }

      for (i11 = 0; i11 < 3; i11++) {
        for (i12 = 0; i12 < 3; i12++) {
          J->data[r5->data[i12 + 3] + J->size[0] * (i11 + 3)] = iv5[i12 + 3 *
            i11];
        }
      }
      ...
      for (i11 = 0; i11 < loop_ub; i11++) {
        for (i12 = 0; i12 < 3; i12++) {
          J->data[r5->data[i12 + 3] + J->size[0] * (i11 + 6)] = 0.0;
        }
      }
      ...
      for (i11 = 0; i11 < loop_ub; i11++) {
        ...
        for (i12 = 0; i12 < ixstart; i12++) {
          J->data[r5->data[i12 + 6] + J->size[0] * i11] = 0.0;
        }
      }
      ...
      if ((J->size[1] == 1) || (P_apr->size[0] == 1)) {
        ...
        for (i11 = 0; i11 < loop_ub; i11++) {
          ...
          for (i12 = 0; i12 < ixstart; i12++) {
            ...
            idx = J->size[1];
            for (n = 0; n < idx; n++) {
              y->data[i11 + y->size[0] * i12] += J->data[i11 + J->size[0] * n] *
                P_apr->data[n + P_apr->size[0] * i12];
            }
          }
        }
      } else {
      ...
      if (b_VIOParameters.fixed_anchor) {
        ...
        i11 = anchorAges->size[0];
        emxEnsureCapacity((emxArray__common *)anchorAges, i11, (int)sizeof
                          (double));
        ...
        if (oldestAnchorIdx != nx) {
          ...
          for (i11 = 0; i11 < loop_ub; i11++) {
            for (i12 = 0; i12 < 3; i12++) {
              P_apr->data[((int)(d3 + (1.0 + (double)i12)) + P_apr->size[0] *
                           i11) - 1] = 0.0;
            }
          }
          ...
          for (i11 = 0; i11 < 3; i11++) {
            for (i12 = 0; i12 < loop_ub; i12++) {
              P_apr->data[i12 + P_apr->size[0] * ((int)(d3 + (1.0 + (double)i11))
                - 1)] = 0.0;
            }
          }
  ...
  if (minNumValidFeatures < minFeatureThreshold) {
    ...
    while ((!exitg1) && (i < 24)) {
      ...
      for (i11 = 0; i11 < loop_ub; i11++) {
        r8->data[r8->size[0] * i11] = (anchorFeatures->data[i +
          anchorFeatures->size[0] * i11] == 1.0);
      }
  ...
  for (i = 0; i < 24; i++) {
    ...
    if (d_any(r9)) {
      ...
      ixstart = i << 2;
      for (i11 = 0; i11 < 2; i11++) {
        h_u_apo->data[i11 + ixstart] = h_u_l[i11];
      }

      for (i11 = 0; i11 < 2; i11++) {
        h_u_apo->data[(i11 + ixstart) + 2] = h_u_r[i11];
      }
    }
  }
